...
// Headings
$_['heading_title']      	= 'Створити новий перелік Etsy';
...
// Text
$_['text_option']      		= 'Оберіть варіант';
$_['text_category_selected']	= 'Обрана категорія';
...
$_['text_created']  		= 'Ваш перелік створено';
$_['text_listing_id']  		= 'Перелік ID';
$_['text_img_upload']  		= 'Завантаження зображення';
$_['text_img_upload_done']  	= 'Зображення завантажене';

// Entry
$_['entry_title']      		= 'Назва товару';
$_['entry_description']     	= 'Опис';
$_['entry_price']      		= 'Ціна';
$_['entry_non_taxable']     	= 'Не оподатковується';
$_['entry_category']     	= 'Top category';
$_['entry_sub_category']    	= 'Суб-категорія';
$_['entry_sub_sub_category']	= 'Суб-суб-категорія';
$_['entry_who_made']		= 'Хто це зробив?';
$_['entry_when_made']		= 'Коли це було зроблено?';
$_['entry_recipient']		= 'Для кого це?';
$_['entry_occasion']		= 'Що це за подія?';
$_['entry_is_supply']		= 'Це пропозиція?';
$_['entry_state']      		= 'Перелік статусів';
...
$_['error_materials']  		= 'Можна додати тільки 13 матеріалів';
$_['error_tags']  		= 'Можна додати тільки 13 тегів';
