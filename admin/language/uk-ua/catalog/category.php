...
// Text
$_['text_success']          		= 'Перелік Категорій обновлен!';
$_['text_list']          		= 'Перелік Категорій';
...
$_['entry_layout']          		= 'Оберіть макет:';

// Help
$_['help_filter']          		= '(Autocomplete)';
$_['help_keyword']          		= 'Замініть пропуски на тире. Має бути унікальним на усю систему.';
$_['help_top']          		= 'Показувати у верхньому меню (працює тільки для основних Категорій)';
$_['help_column']          		= 'Число стовпців для показу Категорій 3-го рівня (працює тільки для основних категорій)';
