...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Авг 22 2017 г., 18:30
...
(2, 2, 'qwer', 'qwre', '', 'afasf', '', 'asdfasdf', '', 220, 3491, ''),
(3, 2, 'sdfsdfsd', 'sdfsdfs', 'sdfsdfs', 'sdfsdfsdfs', '', 'sdfsdfsdf', '', 107, 1663, '');
...
(391, 1, 'yx4pXyDlNgArIVmLjuqDj8P3WwHmbXH5', 's1aqb2hee7msbgol7jcmffhaa3', 'temp_session_599bfd9b7fa0e', '127.0.0.1', '2017-08-22 12:47:07', '2017-08-22 12:47:23'),
(390, 1, 'xinJBtS2cUQ7Q8jXqiBU5rxngkU1jXkR', 's1aqb2hee7msbgol7jcmffhaa3', 'temp_session_599bfd973198b', '127.0.0.1', '2017-08-22 12:47:03', '2017-08-22 12:47:03'),
(389, 1, 'uQ0QkqUNAJ95ctChLUU8Ba3mIy9IPhVn', 's1aqb2hee7msbgol7jcmffhaa3', 'temp_session_599bfd8057370', '127.0.0.1', '2017-08-22 12:46:40', '2017-08-22 12:46:40'),
(388, 1, '2HmvapkoasEIvg5Q542vAB1iKniGF3YH', 's1aqb2hee7msbgol7jcmffhaa3', 'temp_session_599bfd7287297', '127.0.0.1', '2017-08-22 12:46:26', '2017-08-22 12:46:26');
...
(16, 1, 3, 0, 1, 'John', '2016-07-20 10:39:38', 'catalog/1456944747naturehike.jpg'),
(17, 1, 1, 0, 1, 'John', '2016-07-20 10:40:07', 'catalog/bluebird-640x400-1.jpg'),
(18, 1, 4, 0, 1, 'John', '2016-07-20 10:40:39', 'catalog/Fall-beautiful-nature-22666764-900-562.jpg');
...
(74, 2, 's1aqb2hee7msbgol7jcmffhaa3', 443, 0, '[]', 1, '2017-08-22 12:47:09');
...
(61, '', 20, 0, 1, 1, 1, '2017-02-20 11:03:13', '2017-08-14 15:30:18'),
...
(2, 1, 0, 'qwer', 'qwre', 'sssee795@gmail.com', '1234', '', '56459d8badc27af60478bfeb56a407ed930465a0', 'ADd0LEmbS', NULL, NULL, 0, 2, '', '127.0.0.1', 1, 1, 0, '', '', '2017-08-16 03:58:43');
...
(4, 0, 'order_guest', '{\"name\":\"ereye tertret\",\"order_id\":16}', '127.0.0.1', '2017-08-09 18:37:18'),
(5, 0, 'order_guest', '{\"name\":\"asdasd sedfdf\",\"order_id\":19}', '127.0.0.1', '2017-08-11 16:14:57'),
(6, 2, 'register', '{\"customer_id\":2,\"name\":\"qwer qwre\"}', '127.0.0.1', '2017-08-16 03:58:46'),
(7, 2, 'login', '{\"customer_id\":\"2\",\"name\":\"qwer qwre\"}', '127.0.0.1', '2017-08-16 12:51:32'),
(8, 0, 'order_guest', '{\"name\":\"asasd asdasdas\",\"order_id\":22}', '127.0.0.1', '2017-08-16 15:35:53'),
(9, 2, 'login', '{\"customer_id\":\"2\",\"name\":\"qwer qwre\"}', '127.0.0.1', '2017-08-16 15:45:26'),
(10, 0, 'order_guest', '{\"name\":\"dfbgdfgvd dfbdfbfd\",\"order_id\":25}', '127.0.0.1', '2017-08-18 16:49:25'),
(11, 2, 'login', '{\"customer_id\":\"2\",\"name\":\"qwer qwre\"}', '127.0.0.1', '2017-08-21 11:33:47'),
(12, 2, 'address_add', '{\"customer_id\":\"2\",\"name\":\"qwer qwre\"}', '127.0.0.1', '2017-08-21 14:28:44'),
(13, 0, 'order_guest', '{\"name\":\"nnvbnvb vbnvbnvb\",\"order_id\":26}', '127.0.0.1', '2017-08-21 17:10:18');
...
(2, 2, '127.0.0.1', '2017-08-16 03:58:46');
...
(1, '', '127.0.0.1', 4, '2017-07-21 18:22:19', '2017-08-09 18:15:32');
...
(1461, 'module', 'cosyone_twitterfeed'),
...
(1462, 'module', 'adv_ajaxfilter'),
(1458, 'module', 'mega_filter'),
(1460, 'module', 'quickcheckout'),
(1463, 'module', 'blog_category'),
...
INSERT INTO `oc_filter` (`filter_id`, `filter_group_id`, `sort_order`, `color`) VALUES
(2, 1, 0, '2222'),
(1, 1, 0, '1111');
...
--
-- Структура таблицы `oc_informationf`
--

CREATE TABLE `oc_informationf` (
  `information_id` int(11) NOT NULL,
  `bottom` int(1) NOT NULL DEFAULT '0',
  `top` int(1) NOT NULL DEFAULT '0',
  `sort_order` int(3) NOT NULL DEFAULT '0',
...
--
-- Дамп данных таблицы `oc_informationf`
--

INSERT INTO `oc_informationf` (`information_id`, `bottom`, `top`, `sort_order`, `status`) VALUES
(8, 0, 0, 0, 1),
(7, 0, 0, 0, 1);
...
--
-- Структура таблицы `oc_informationf_description`
--

CREATE TABLE `oc_informationf_description` (
  `information_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `title` varchar(64) NOT NULL,
  `description` text NOT NULL,
...
--
-- Дамп данных таблицы `oc_informationf_description`
--

INSERT INTO `oc_informationf_description` (`information_id`, `language_id`, `title`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
(8, 3, 'Our production', 'Our production', 'Our production', '', ''),
(8, 2, 'Наше производство', '&lt;p&gt;Наше производство&lt;br&gt;&lt;/p&gt;', 'Наше производство', '', ''),
(7, 2, 'О компании', '&lt;p&gt;О компании&lt;br&gt;&lt;/p&gt;', 'О компании', '', ''),
(7, 4, 'Про компанію', '&lt;p&gt;Про компанію&lt;br&gt;&lt;/p&gt;', 'Про компанію', '', ''),
(7, 3, 'About company', '&lt;p&gt;About company&lt;br&gt;&lt;/p&gt;', 'About company', '', ''),
(8, 4, 'Наше виробництво', 'Наше виробництво', 'Наше виробництво', '', '');

-- --------------------------------------------------------

--
-- Структура таблицы `oc_informationf_to_layout`
--

CREATE TABLE `oc_informationf_to_layout` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Дамп данных таблицы `oc_informationf_to_layout`
--

INSERT INTO `oc_informationf_to_layout` (`information_id`, `store_id`, `layout_id`) VALUES
(7, 0, 0),
(8, 0, 0);
...
--
-- Структура таблицы `oc_informationf_to_store`
--

CREATE TABLE `oc_informationf_to_store` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Дамп данных таблицы `oc_informationf_to_store`
--

INSERT INTO `oc_informationf_to_store` (`information_id`, `store_id`) VALUES
(7, 0),
(8, 0);
...
(4, 2, 'FAQ', '&lt;div class=&quot;panel panel-default&quot;&gt;\r\n            &lt;div class=&quot;panel-heading&quot;&gt;\r\n              &lt;h4 class=&quot;panel-title&quot;&gt;\r\n                &lt;a data-toggle=&quot;collapse&quot; data-parent=&quot;#accordion&quot; href=&quot;#collapse1&quot;&gt;\r\n                &lt;i class=&quot;fa fa-chevron-right&quot; aria-hidden=&quot;true&quot;&gt;&lt;/i&gt;\r\n               Как мне узнать что мой заказ корректно оформлен?&lt;/a&gt;\r\n              &lt;/h4&gt;\r\n            &lt;/div&gt;\r\n            &lt;div id=&quot;collapse1&quot; class=&quot;panel-collapse collapse&quot;&gt;\r\n              &lt;div class=&quot;panel-body&quot;&gt;\r\n                &lt;p&gt;Если Ваш заказ корректно оформлен, Вы получите электронное письмо с подтверждением заказа. Заказ будет считаться полученным после получения подтверждения о доставке.&lt;/p&gt;\r\n              &lt;/div&gt;\r\n            &lt;/div&gt;\r\n          &lt;/div&gt;\r\n          &lt;div class=&quot;panel panel-default&quot;&gt;\r\n            &lt;div class=&quot;panel-heading&quot;&gt;\r\n              &lt;h4 class=&quot;panel-title&quot;&gt;\r\n                &lt;a data-toggle=&quot;collapse&quot; data-parent=&quot;#accordion&quot; href=&quot;#collapse2&quot;&gt;\r\n                &lt;i class=&quot;fa fa-chevron-right&quot; aria-hidden=&quot;true&quot;&gt;&lt;/i&gt;\r\n                При получении товара я обнаружил дефект; как я могу осуществить возврат?&lt;/a&gt;\r\n              &lt;/h4&gt;\r\n            &lt;/div&gt;\r\n            &lt;div id=&quot;collapse2&quot; class=&quot;panel-collapse collapse&quot;&gt;\r\n              &lt;div class=&quot;panel-body&quot;&gt;&lt;p&gt;Если, к сожалению, Вам пришли изделия, не соответствующие по качеству Вашим запросам, Вы можете вернуть приобретенное изделие в течение 14 дней со дня доставки, заполнив запрос о возврате. В течение 14 дней, Вы можете связаться с нами, заполнив специальную анкету в разделе &quot;Свяжитесь с нами&quot;, или же отправив нам электронное письмо на адрес support.fidelitti@gmail.com, указав данные, касающиеся Вашего заказа (дата покупки и номер заказа), и отправив нам фотографию изделия, на которой четко виден брак.&lt;/p&gt;&lt;/div&gt;\r\n            &lt;/div&gt;\r\n          &lt;/div&gt;\r\n          &lt;div class=&quot;panel panel-default&quot;&gt;\r\n            &lt;div class=&quot;panel-heading&quot;&gt;\r\n              &lt;h4 class=&quot;panel-title&quot;&gt;\r\n                &lt;a data-toggle=&quot;collapse&quot; data-parent=&quot;#accordion&quot; href=&quot;#collapse3&quot;&gt;\r\n                &lt;i class=&quot;fa fa-chevron-right&quot; aria-hidden=&quot;true&quot;&gt;&lt;/i&gt;\r\n                После подтверждения заказа оператор сообщил мне,что некоторых всех позиций из заказа нет в наличии,как мне поступить?&lt;/a&gt;\r\n              &lt;/h4&gt;\r\n            &lt;/div&gt;\r\n            &lt;div id=&quot;collapse3&quot; class=&quot;panel-collapse collapse&quot;&gt;\r\n              &lt;div class=&quot;panel-body&quot;&gt;&lt;p&gt;К сожалению, ассортимент на сайте не всегда успевает обновляться. Если сложилась такая ситуация, оператор предложит Вам оформить предзаказ или предложит взамен похожий товар, который есть в наличии.  В качестве извинений за доставленные неудобства, мы предоставим Вам скидку на следующую Вашу покупку.&lt;/p&gt;&lt;/div&gt;\r\n            &lt;/div&gt;\r\n          &lt;/div&gt;\r\n\r\n\r\n\r\n&lt;div class=&quot;panel panel-default&quot;&gt;\r\n            &lt;div class=&quot;panel-heading&quot;&gt;\r\n              &lt;h4 class=&quot;panel-title&quot;&gt;\r\n                &lt;a data-toggle=&quot;collapse&quot; data-parent=&quot;#accordion&quot; href=&quot;#collapse4&quot;&gt;\r\n                &lt;i class=&quot;fa fa-chevron-right&quot; aria-hidden=&quot;true&quot;&gt;&lt;/i&gt;\r\n                Могу я изменить контактную информацию/адрес доставки?&lt;/a&gt;\r\n              &lt;/h4&gt;\r\n            &lt;/div&gt;\r\n            &lt;div id=&quot;collapse4&quot; class=&quot;panel-collapse collapse&quot;&gt;\r\n              &lt;div class=&quot;panel-body&quot;&gt;&lt;p&gt;Вы можете изменить контактную информацию в личном кабинете или связавшись с операторами нашего колл-центра.&lt;/p&gt;&lt;/div&gt;\r\n            &lt;/div&gt;\r\n          &lt;/div&gt;\r\n\r\n\r\n&lt;div class=&quot;panel panel-default&quot;&gt;\r\n            &lt;div class=&quot;panel-heading&quot;&gt;\r\n              &lt;h4 class=&quot;panel-title&quot;&gt;\r\n                &lt;a data-toggle=&quot;collapse&quot; data-parent=&quot;#accordion&quot; href=&quot;#collapse5&quot;&gt;\r\n                &lt;i class=&quot;fa fa-chevron-right&quot; aria-hidden=&quot;true&quot;&gt;&lt;/i&gt;\r\n                Могу ли я обменять товар?&lt;/a&gt;\r\n              &lt;/h4&gt;\r\n            &lt;/div&gt;\r\n            &lt;div id=&quot;collapse5&quot; class=&quot;panel-collapse collapse&quot;&gt;\r\n              &lt;div class=&quot;panel-body&quot;&gt;&lt;p&gt;Если Вы не использовали товар, мы обменяем его в течение 14 дней с момента покупки. Для этого Вам необходимо заполнить форму в разделе “Возврат/Обмен”или связаться с нами по телефону.&lt;/p&gt;&lt;/div&gt;\r\n            &lt;/div&gt;\r\n          &lt;/div&gt;\r\n\r\n&lt;div class=&quot;panel panel-default&quot;&gt;\r\n            &lt;div class=&quot;panel-heading&quot;&gt;\r\n              &lt;h4 class=&quot;panel-title&quot;&gt;\r\n                &lt;a data-toggle=&quot;collapse&quot; data-parent=&quot;#accordion&quot; href=&quot;#collapse6&quot;&gt;\r\n                &lt;i class=&quot;fa fa-chevron-right&quot; aria-hidden=&quot;true&quot;&gt;&lt;/i&gt;\r\n                Могу ли я изменить отменить мой заказ?&lt;/a&gt;\r\n              &lt;/h4&gt;\r\n            &lt;/div&gt;\r\n            &lt;div id=&quot;collapse6&quot; class=&quot;panel-collapse collapse&quot;&gt;\r\n              &lt;div class=&quot;panel-body&quot;&gt;&lt;p&gt;Отменить/изменить заказ можно позвонив по номеру нашего колл-центра  . Если Вы уже оплатили покупку с помощью карты, деньги вернутся на ваш счет в течение семи рабочих дней.&lt;/p&gt;&lt;/div&gt;\r\n            &lt;/div&gt;\r\n          &lt;/div&gt;\r\n\r\n\r\n&lt;div class=&quot;panel panel-default&quot;&gt;\r\n            &lt;div class=&quot;panel-heading&quot;&gt;\r\n              &lt;h4 class=&quot;panel-title&quot;&gt;\r\n                &lt;a data-toggle=&quot;collapse&quot; data-parent=&quot;#accordion&quot; href=&quot;#collapse7&quot;&gt;\r\n                &lt;i class=&quot;fa fa-chevron-right&quot; aria-hidden=&quot;true&quot;&gt;&lt;/i&gt;\r\n                Как я могу совершить покупку?&lt;/a&gt;\r\n              &lt;/h4&gt;\r\n            &lt;/div&gt;\r\n            &lt;div id=&quot;collapse7&quot; class=&quot;panel-collapse collapse&quot;&gt;\r\n              &lt;div class=&quot;panel-body&quot;&gt;&lt;p&gt;С помощью навигационного меню выберите интересующий Вас товар, укажите его размер и добавьте в корзину. Чтобы оформить заказ, укажите Ваши личные данные, удобные способы оплаты и доставки. В ближайшее время с Вами свяжется менеджер, чтобы подтвердить заказ и уточнить необходимые детали. &lt;/p&gt;&lt;p&gt;\r\nТакже на сайте доступна функция &quot;Купить в один клик&quot;, с помощью которой Вы можете оформить заказ в считанные секунды. Для этого выберите интересующий Вас товар, укажите его размер и нажмите на кнопку &quot;Купить в один клик&quot;. В появившемся окне оставьте Ваш e-mail ,имя и номер телефона. В ближайшее время с Вами свяжется оператор, чтобы подтвердить заказ и уточнить необходимые детали. &lt;/p&gt;&lt;/div&gt;\r\n            &lt;/div&gt;\r\n          &lt;/div&gt;\r\n\r\n&lt;div class=&quot;panel panel-default&quot;&gt;\r\n            &lt;div class=&quot;panel-heading&quot;&gt;\r\n              &lt;h4 class=&quot;panel-title&quot;&gt;\r\n                &lt;a data-toggle=&quot;collapse&quot; data-parent=&quot;#accordion&quot; href=&quot;#collapse8&quot;&gt;\r\n                &lt;i class=&quot;fa fa-chevron-right&quot; aria-hidden=&quot;true&quot;&gt;&lt;/i&gt;\r\n                Как я могу найти интересующий меня товар?&lt;/a&gt;\r\n              &lt;/h4&gt;\r\n            &lt;/div&gt;\r\n            &lt;div id=&quot;collapse8&quot; class=&quot;panel-collapse collapse&quot;&gt;\r\n              &lt;div class=&quot;panel-body&quot;&gt;&lt;p&gt;Вы можете использовать выпадающее меню поиска.Здесь представлены основные виды продукции и категории: сумки, мини-сумки, кошельки, аксессуары и новые поступления. Воспользуйтесь поиском по ключевым словам: вставьте ключевое слово в поле, предназначенное для поиска в правом верхнем углу, и увидите список результатов, соответствующих этой категории. Ключевое слово может быть названием продукта (например, Tondo), цветом (например, белый), категорией (например, рюкзаки) или элементом артикула. Кроме того, Вы можете использовать поиск по фильтру: внутри каждой категории можно усовершенствовать свой выбор с помощью фильтров в верхней части. Вы можете комбинировать эти критерии, чтобы найти необходимый товар быстрее, используя тип, цвет и материал.&lt;/p&gt;&lt;/div&gt;\r\n            &lt;/div&gt;\r\n          &lt;/div&gt;\r\n\r\n&lt;div class=&quot;panel panel-default&quot;&gt;\r\n            &lt;div class=&quot;panel-heading&quot;&gt;\r\n              &lt;h4 class=&quot;panel-title&quot;&gt;\r\n                &lt;a data-toggle=&quot;collapse&quot; data-parent=&quot;#accordion&quot; href=&quot;#collapse9&quot;&gt;\r\n                &lt;i class=&quot;fa fa-chevron-right&quot; aria-hidden=&quot;true&quot;&gt;&lt;/i&gt;\r\n                Как я могу воспользоваться промо-кодом?&lt;/a&gt;\r\n              &lt;/h4&gt;\r\n            &lt;/div&gt;\r\n            &lt;div id=&quot;collapse9&quot; class=&quot;panel-collapse collapse&quot;&gt;\r\n              &lt;div class=&quot;panel-body&quot;&gt;&lt;p&gt;Если у Вас есть промо-код, Вам необходимо ввести его в специальное поле, которое появится в процессе оформления заказа&lt;/p&gt;&lt;/div&gt;\r\n            &lt;/div&gt;\r\n          &lt;/div&gt;\r\n\r\n&lt;div class=&quot;panel panel-default&quot;&gt;\r\n            &lt;div class=&quot;panel-heading&quot;&gt;\r\n              &lt;h4 class=&quot;panel-title&quot;&gt;\r\n                &lt;a data-toggle=&quot;collapse&quot; data-parent=&quot;#accordion&quot; href=&quot;#collapse10&quot;&gt;\r\n                &lt;i class=&quot;fa fa-chevron-right&quot; aria-hidden=&quot;true&quot;&gt;&lt;/i&gt;\r\n                У меня сломалась молния или замок у моей сумки,как я могу ее отремонтировать?&lt;/a&gt;\r\n              &lt;/h4&gt;\r\n            &lt;/div&gt;\r\n            &lt;div id=&quot;collapse10&quot; class=&quot;panel-collapse collapse&quot;&gt;\r\n              &lt;div class=&quot;panel-body&quot;&gt;&lt;p&gt;Для получения информации по ремонту, свяжитесь с нами через форму обратной связи, с указанием номера Вашего заказа и приложенным фото изделия.&lt;/p&gt;&lt;/div&gt;\r\n            &lt;/div&gt;\r\n          &lt;/div&gt;', 'FAQ', '', ''),
(4, 3, 'FAQ', '&lt;div class=&quot;panel panel-default&quot;&gt;\r\n            &lt;div class=&quot;panel-heading&quot;&gt;\r\n              &lt;h4 class=&quot;panel-title&quot;&gt;\r\n                &lt;a data-toggle=&quot;collapse&quot; data-parent=&quot;#accordion&quot; href=&quot;#collapse1&quot;&gt;\r\n                &lt;i class=&quot;fa fa-chevron-right&quot; aria-hidden=&quot;true&quot;&gt;&lt;/i&gt;\r\n                Collapsible Group 1&lt;/a&gt;\r\n              &lt;/h4&gt;\r\n            &lt;/div&gt;\r\n            &lt;div id=&quot;collapse1&quot; class=&quot;panel-collapse collapse&quot;&gt;\r\n              &lt;div class=&quot;panel-body&quot;&gt;\r\n                &lt;h3&gt;qweqwe&lt;/h3&gt;\r\n                &lt;h4&gt;qweeqw&lt;/h4&gt;\r\n                &lt;h5&gt;qweqweqweqweqweqwe&lt;/h5&gt;\r\n                &lt;ul&gt;\r\n                  &lt;li&gt;qeqweqweqw eqw &lt;/li&gt;\r\n                  &lt;li&gt;qeqweqweqw eqw &lt;/li&gt;\r\n                  &lt;li&gt;qeqweqweqw eqw &lt;/li&gt;\r\n                  &lt;li&gt;qeqweqweqw eqw &lt;/li&gt;\r\n                  &lt;li&gt;qeqweqweqw eqw &lt;/li&gt;\r\n                &lt;/ul&gt;\r\n\r\n                &lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias, laborum cumque itaque ut vel aliquid laboriosam reprehenderit quas nam &lt;b&gt;quibusdam sapiente&lt;/b&gt; veniam quam impedit commodi est, temporibus maiores! Totam, doloribus!&lt;/p&gt;\r\n                &lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias.&lt;/p&gt;\r\n                &lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias, laborum cumque itaque ut vel &lt;i&gt;aliquid laboriosam reprehenderit quas nam quibusdam sapiente veniam quam impedit&lt;/i&gt; commodi est, temporibus maiores! Totam, doloribus!&lt;/p&gt;\r\n              &lt;/div&gt;\r\n            &lt;/div&gt;\r\n          &lt;/div&gt;\r\n          &lt;div class=&quot;panel panel-default&quot;&gt;\r\n            &lt;div class=&quot;panel-heading&quot;&gt;\r\n              &lt;h4 class=&quot;panel-title&quot;&gt;\r\n                &lt;a data-toggle=&quot;collapse&quot; data-parent=&quot;#accordion&quot; href=&quot;#collapse2&quot;&gt;\r\n                &lt;i class=&quot;fa fa-chevron-right&quot; aria-hidden=&quot;true&quot;&gt;&lt;/i&gt;\r\n                Collapsible Group 2&lt;/a&gt;\r\n              &lt;/h4&gt;\r\n            &lt;/div&gt;\r\n            &lt;div id=&quot;collapse2&quot; class=&quot;panel-collapse collapse&quot;&gt;\r\n              &lt;div class=&quot;panel-body&quot;&gt;Lorem ipsum dolor sit amet, consectetur adipisicing elit,\r\n              sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad\r\n              minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea\r\n              commodo consequat.&lt;/div&gt;\r\n            &lt;/div&gt;\r\n          &lt;/div&gt;\r\n          &lt;div class=&quot;panel panel-default&quot;&gt;\r\n            &lt;div class=&quot;panel-heading&quot;&gt;\r\n              &lt;h4 class=&quot;panel-title&quot;&gt;\r\n                &lt;a data-toggle=&quot;collapse&quot; data-parent=&quot;#accordion&quot; href=&quot;#collapse3&quot;&gt;\r\n                &lt;i class=&quot;fa fa-chevron-right&quot; aria-hidden=&quot;true&quot;&gt;&lt;/i&gt;\r\n                Collapsible Group 3&lt;/a&gt;\r\n              &lt;/h4&gt;\r\n            &lt;/div&gt;\r\n            &lt;div id=&quot;collapse3&quot; class=&quot;panel-collapse collapse&quot;&gt;\r\n              &lt;div class=&quot;panel-body&quot;&gt;Lorem ipsum dolor sit amet, consectetur adipisicing elit,\r\n              sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad\r\n              minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea\r\n              commodo consequat.&lt;/div&gt;\r\n            &lt;/div&gt;\r\n          &lt;/div&gt;', 'FAQ', '', ''),
(4, 4, 'FAQ', '&lt;div class=&quot;panel panel-default&quot;&gt;\r\n            &lt;div class=&quot;panel-heading&quot;&gt;\r\n              &lt;h4 class=&quot;panel-title&quot;&gt;\r\n                &lt;a data-toggle=&quot;collapse&quot; data-parent=&quot;#accordion&quot; href=&quot;#collapse1&quot;&gt;\r\n                &lt;i class=&quot;fa fa-chevron-right&quot; aria-hidden=&quot;true&quot;&gt;&lt;/i&gt;\r\n                Collapsible Group 1&lt;/a&gt;\r\n              &lt;/h4&gt;\r\n            &lt;/div&gt;\r\n            &lt;div id=&quot;collapse1&quot; class=&quot;panel-collapse collapse&quot;&gt;\r\n              &lt;div class=&quot;panel-body&quot;&gt;\r\n                &lt;h3&gt;qweqwe&lt;/h3&gt;\r\n                &lt;h4&gt;qweeqw&lt;/h4&gt;\r\n                &lt;h5&gt;qweqweqweqweqweqwe&lt;/h5&gt;\r\n                &lt;ul&gt;\r\n                  &lt;li&gt;qeqweqweqw eqw &lt;/li&gt;\r\n                  &lt;li&gt;qeqweqweqw eqw &lt;/li&gt;\r\n                  &lt;li&gt;qeqweqweqw eqw &lt;/li&gt;\r\n                  &lt;li&gt;qeqweqweqw eqw &lt;/li&gt;\r\n                  &lt;li&gt;qeqweqweqw eqw &lt;/li&gt;\r\n                &lt;/ul&gt;\r\n\r\n                &lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias, laborum cumque itaque ut vel aliquid laboriosam reprehenderit quas nam &lt;b&gt;quibusdam sapiente&lt;/b&gt; veniam quam impedit commodi est, temporibus maiores! Totam, doloribus!&lt;/p&gt;\r\n                &lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias.&lt;/p&gt;\r\n                &lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias, laborum cumque itaque ut vel &lt;i&gt;aliquid laboriosam reprehenderit quas nam quibusdam sapiente veniam quam impedit&lt;/i&gt; commodi est, temporibus maiores! Totam, doloribus!&lt;/p&gt;\r\n              &lt;/div&gt;\r\n            &lt;/div&gt;\r\n          &lt;/div&gt;\r\n          &lt;div class=&quot;panel panel-default&quot;&gt;\r\n            &lt;div class=&quot;panel-heading&quot;&gt;\r\n              &lt;h4 class=&quot;panel-title&quot;&gt;\r\n                &lt;a data-toggle=&quot;collapse&quot; data-parent=&quot;#accordion&quot; href=&quot;#collapse2&quot;&gt;\r\n                &lt;i class=&quot;fa fa-chevron-right&quot; aria-hidden=&quot;true&quot;&gt;&lt;/i&gt;\r\n                Collapsible Group 2&lt;/a&gt;\r\n              &lt;/h4&gt;\r\n            &lt;/div&gt;\r\n            &lt;div id=&quot;collapse2&quot; class=&quot;panel-collapse collapse&quot;&gt;\r\n              &lt;div class=&quot;panel-body&quot;&gt;Lorem ipsum dolor sit amet, consectetur adipisicing elit,\r\n              sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad\r\n              minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea\r\n              commodo consequat.&lt;/div&gt;\r\n            &lt;/div&gt;\r\n          &lt;/div&gt;\r\n          &lt;div class=&quot;panel panel-default&quot;&gt;\r\n            &lt;div class=&quot;panel-heading&quot;&gt;\r\n              &lt;h4 class=&quot;panel-title&quot;&gt;\r\n                &lt;a data-toggle=&quot;collapse&quot; data-parent=&quot;#accordion&quot; href=&quot;#collapse3&quot;&gt;\r\n                &lt;i class=&quot;fa fa-chevron-right&quot; aria-hidden=&quot;true&quot;&gt;&lt;/i&gt;\r\n                Collapsible Group 3&lt;/a&gt;\r\n              &lt;/h4&gt;\r\n            &lt;/div&gt;\r\n            &lt;div id=&quot;collapse3&quot; class=&quot;panel-collapse collapse&quot;&gt;\r\n              &lt;div class=&quot;panel-body&quot;&gt;Lorem ipsum dolor sit amet, consectetur adipisicing elit,\r\n              sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad\r\n              minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea\r\n              commodo consequat.&lt;/div&gt;\r\n            &lt;/div&gt;\r\n          &lt;/div&gt;', 'FAQ', '', ''),
(7, 4, 'Вакансии', '&lt;p&gt;Вакансии&lt;br&gt;&lt;/p&gt;', 'Вакансии', '', ''),
(7, 2, 'Вакансии', '&lt;h3&gt;В нашей компании сейчас открыты такие вакансии:&lt;/h3&gt;\r\n&lt;ul&gt;\r\n&lt;li&gt;&lt;a href=&quot;https://www.work.ua/jobs/2472402/&quot; class=&quot;work-a&quot; target=&quot;_blank&quot;&gt;Интернет-маркетолог&lt;/a&gt;&lt;br&gt; Одесса&lt;/li&gt;\r\n&lt;li&gt;&lt;a href=&quot;https://www.work.ua/jobs/1952006/&quot; class=&quot;work-a&quot; target=&quot;_blank&quot;&gt;Покрасчик-отделочник кожаных изделий&lt;/a&gt;, &lt;b title=&quot;Зп от выработки&quot;&gt;7000&amp;nbsp;грн&lt;sup title=&quot;Зп от выработки&quot;&gt;*&lt;/sup&gt;&lt;/b&gt;&lt;br&gt; Одесса&lt;/li&gt;&lt;li&gt;&lt;a href=&quot;https://www.work.ua/jobs/2603567/&quot; class=&quot;work-a&quot; target=&quot;_blank&quot;&gt;Сапожник, обувщик на производство&lt;/a&gt;&lt;br&gt; Одесса&lt;/li&gt;\r\n&lt;li&gt;&lt;a href=&quot;https://www.work.ua/jobs/1896330/&quot; class=&quot;work-a&quot; target=&quot;_blank&quot;&gt;Сборщик, комплектовщик, заготовитель, столовик (кожгалантерея)&lt;/a&gt;, &lt;b&gt;7000&amp;nbsp;грн&lt;/b&gt;&lt;br&gt; Одесса&lt;/li&gt;&lt;li&gt;&lt;a href=&quot;https://www.work.ua/jobs/2234956/&quot; class=&quot;work-a&quot; target=&quot;_blank&quot;&gt;Упаковщик&lt;/a&gt;, &lt;b&gt;7000&amp;nbsp;грн&lt;/b&gt;&lt;br&gt; Одесса&lt;/li&gt;\r\n&lt;li&gt;&lt;a href=&quot;https://www.work.ua/jobs/1934950/&quot; class=&quot;work-a&quot; target=&quot;_blank&quot;&gt;Установщик фурнитуры на кожгалантерею&lt;/a&gt;, &lt;b title=&quot;зп от выработки&quot;&gt;7000&amp;nbsp;грн&lt;sup title=&quot;зп от выработки&quot;&gt;*&lt;/sup&gt;&lt;/b&gt;&lt;br&gt; Одесса&lt;/li&gt;\r\n&lt;li&gt;&lt;a href=&quot;https://www.work.ua/jobs/2817279/&quot; class=&quot;work-a&quot; target=&quot;_blank&quot;&gt;Фотограф (Instagram)&lt;/a&gt;&lt;br&gt; Одесса&lt;/li&gt;\r\n&lt;li&gt;&lt;a href=&quot;https://www.work.ua/jobs/1878664/&quot; class=&quot;work-a&quot; target=&quot;_blank&quot;&gt;Швея&lt;/a&gt;, &lt;b title=&quot;и выше&quot;&gt;15000&amp;nbsp;грн&lt;sup title=&quot;и выше&quot;&gt;*&lt;/sup&gt;&lt;/b&gt;&lt;br&gt; Одесса&lt;/li&gt;\r\n&lt;li&gt;&lt;a href=&quot;https://www.work.ua/jobs/2594304/&quot; class=&quot;work-a&quot; target=&quot;_blank&quot;&gt;Швея-заготовщик верха обуви&lt;/a&gt;, &lt;b title=&quot;и выше от выработки&quot;&gt;12000&amp;nbsp;грн&lt;sup title=&quot;и выше от выработки&quot;&gt;*&lt;/sup&gt;&lt;/b&gt;&lt;br&gt; Одесса&lt;/li&gt;\r\n&lt;/ul&gt;\r\n\r\n&lt;a href=&quot;https://www.work.ua/jobs/by-company/460866/#open-jobs&quot; target=&quot;_blank&quot;&gt;Все вакансии компании «Fidelitti»&lt;/a&gt; на &lt;a href=&quot;https://www.work.ua/&quot; target=&quot;_blank&quot;&gt;Work.ua&lt;/a&gt;', 'Вакансии', '', ''),
(7, 3, 'Вакансии', '&lt;p&gt;Вакансии&lt;br&gt;&lt;/p&gt;', 'Вакансии', '', ''),
(8, 3, 'policy', 'asdasdas', 'policy', '', ''),
(8, 2, 'Политика конфиденциальности', '&lt;p&gt;Администрация сайта &lt;b&gt;fidelitti.com&lt;/b&gt; (далее Сайт) с уважением относится к правам посетителей Сайта. Мы безоговорочно признаем важность конфиденциальности личной информации посетителей нашего Сайта.&lt;/p&gt;&lt;p&gt;\r\nПосещая Сайт, Вы полностью соглашаетесь с данной Политикой конфиденциальности.\r\nОсновные положения нашей политики конфиденциальности формулируются следующим образом:&lt;/p&gt;&lt;ul&gt;&lt;li&gt;Мы не передаем Вашу персональную информацию третьим лицам.&lt;/li&gt;&lt;li&gt;Мы не передаем Вашу контактную информацию без Вашего согласия.&lt;/li&gt;&lt;li&gt;Вы самостоятельно определяете объем раскрываемой персональной информации.&lt;/li&gt;&lt;/ul&gt;&lt;p&gt;&lt;b&gt;\r\n \r\n\r\nСобираемая информация&lt;/b&gt;&lt;/p&gt;&lt;p&gt;\r\nМы собираем следующую информацию:&lt;/p&gt;&lt;p&gt;\r\n•       Техническая информация, автоматически собираемая программным обеспечением Сайта во время его посещения.&lt;/p&gt;&lt;p&gt;\r\n•       Персональная информация, предоставляемая Вами при заполнении форм обратной связи.&lt;/p&gt;&lt;p&gt;&lt;b&gt;\r\nТЕХНИЧЕСКАЯ ИНФОРМАЦИЯ.&lt;/b&gt;&lt;/p&gt;&lt;p&gt;\r\nВо время посещения вами Сайта, администрации Сайта автоматически становится доступной информация из стандартных журналов регистрации сервера. Сюда включается IP-адрес Вашего компьютера (или прокси-сервера, если он используется для выхода в Интернет), имя Интернет-провайдера, имя домена, тип браузера и операционной системы, информация о сайте, с которого Вы совершили переход на Сайт, страницах Сайта, которые Вы посещаете, дате и времени этих посещений, файлах, которые Вы загружаете. Это информация анализируется нами в агрегированном (обезличенном) виде для анализа посещаемости Сайта, и используется при разработке предложений по его улучшению и развитию. Связь между Вашим IP-адресом и Вашей персональной информацией никогда не раскрывается третьим лицам, за исключением тех случаев, когда это требует законодательство.\r\nТехническую информацию о посещении Сайта (обезличенную) также собирают установленные на сайте счетчики статистики.&lt;/p&gt;&lt;p&gt;&lt;b&gt;\r\nИспользование полученной информации&lt;/b&gt;&lt;/p&gt;&lt;p&gt;\r\nИнформация, предоставляемая Вами при заполнении форм обратной связи, а также техническая информация, используется исключительно для улучшения работы сайта. Вся контактная информация, которую Вы нам предоставляете, раскрывается только с Вашего разрешения. Адреса электронной почты никогда не публикуются на Сайте и используются нами только для связи с Вами.&lt;/p&gt;&lt;p&gt;&lt;b&gt;\r\nПредоставление информации третьим лицам&lt;/b&gt;&lt;/p&gt;&lt;p&gt;\r\nМы никогда не предоставляем Вашу личную информацию третьим лицам, кроме:&lt;/p&gt;&lt;ul&gt;&lt;li&gt;случаев предотвращения преступления или нанесения ущерба нам или третьим лицам;&lt;/li&gt;&lt;li&gt;третьих лиц, которые предоставляют нам поддержку и услуги, с помощью которых Вы получаете Ваш заказ.\r\n&lt;/li&gt;&lt;/ul&gt;&lt;p&gt;&lt;b&gt; \r\nЗащита данных&lt;/b&gt;&lt;/p&gt;&lt;p&gt;\r\nАдминистрация Сайта осуществляет защиту информации, предоставленной пользователями, и использует ее только в соответствии с принятой Политикой конфиденциальности. На Сайте используются общепринятые методы безопасности для обеспечения защиты информации от потери, искажения и несанкционированного распространения. Безопасность реализуется программными средствами сетевой защиты, процедурами проверки доступа, применением криптографических средств защиты информации, соблюдением политики конфиденциальности.&lt;/p&gt;&lt;p&gt;&lt;b&gt;\r\nЗаключительные положения&lt;/b&gt;&lt;/p&gt;&lt;p&gt;\r\nНикакие из содержащихся здесь заявлений не означают заключения договора или соглашения между Владельцем Сайта и Пользователем, предоставляющим персональную информацию. Политика конфиденциальности лишь проинформирует Вас о подходах Сайта к работе с персональными данными.&lt;/p&gt;&lt;p&gt;\r\nМы оставляем за собой право вносить изменения в настоящую политику конфиденциальности в любое время без предварительного уведомления.&lt;/p&gt;', 'Политика конфиденциальности', '', ''),
(8, 4, 'asdasdas', '&lt;p&gt;asdasdas&lt;/p&gt;', 'asdasdasdasd', '', ''),
(9, 3, 'Политика cookies', '&lt;ul style=&quot;box-sizing: inherit; list-style-position: outside; list-style-image: initial; margin-right: 0px; margin-bottom: 1rem; margin-left: 8px; padding: 0px; color: rgb(10, 10, 10); font-family: Helvetica; font-size: 16px; letter-spacing: 0.9px;&quot;&gt;&lt;li style=&quot;box-sizing: inherit; margin: 0px; padding: 9px 0px 0px 31px; font-size: inherit; list-style-type: none; background: url(&amp;quot;/catalog/view/theme/fidelitti/images/jobs-icon-list.png&amp;quot;) 14px 17px no-repeat;&quot;&gt;&lt;a href=&quot;http://test.fidelitti.com/cookies&quot; rel=&quot;insert&quot; style=&quot;box-sizing: inherit; outline: none; line-height: inherit; color: rgb(0, 0, 0); cursor: pointer;&quot;&gt;Политика cookies&lt;/a&gt;&lt;/li&gt;&lt;/ul&gt;', 'Политика cookies', '', ''),
(9, 2, 'Политика cookies', '&lt;p&gt;Веб-сайт&lt;b&gt; fidelitti.com&lt;/b&gt; использует файлы cookie или похожие технологии в целях улучшения Вашей навигации по веб-сайту, а также для отправки Вам рекламных сообщений, отвечающих Вашим интересам, как приведено ниже.&lt;/p&gt;&lt;p&gt;&lt;b&gt;\r\nПОНЯТИЯ&lt;/b&gt;&lt;/p&gt;&lt;p&gt;\r\nФайлы Cookies - это простые текстовые файлы, позволяющие веб-серверу хранить информацию о Вашем электронном устройстве (компьютере, планшете, смартфоне и т.д.) на протяжении Вашего посещения (сессионные файлы cookie) и для последующих посещений веб-сайта (постоянные файлы cookie). Браузер сохраняет их в соответствии с выбранными Вами настройками. Похожие механизмы, такие как, веб-маяки (web beacons), прозрачные GIF-файлы и все формы местного хранения введенные HTML5 также могут быть использованы для сбора информации о предпочтениях пользователя. В целях упрощения понятий, ссылаясь на файлы &quot;cookie&quot;, мы подразумеваем все приведенные выше механизмы. Файлы cookies не содержат и не используются компанией Fidelitti, ее аффилированными лицами и ни одним из её сторонних провайдеров услуг для сбора, записи или хранения каких-либо Ваших персональных данных, включая Вашу Ф.И.О., дату рождения, адрес, номера телефонов, пасcпортные данные, данные платежных карт (кредитной, дебетовой или иной) и иные данные.&lt;/p&gt;&lt;p&gt;&lt;b&gt;\r\nВИДЫ ФАЙЛОВ COOKIES&lt;/b&gt;&lt;/p&gt;&lt;p&gt;&lt;b&gt;\r\nТехнические cookies&lt;/b&gt;&lt;/p&gt;&lt;p&gt;\r\nСессионные файлы cookies: Они необходимы для обеспечения надлежащего функционирования нашего веб-сайта, и используются для управления регистрацией/аутентификацией и доступом к определенным услугам. Они временно сохраняются во время сеанса навигации и автоматически удаляются из Вашего устройства при закрытии браузера. Обратите внимание на то, что при отключении сессионных файлов cookies, Ваш доступ к тем услугам, которые требующют регистрации/аутентификации, может быть ограничен. Постоянные, статистические и связанные с оптимизацией файлы cookies позволяют нам собирать и анализировать (анонимно) траффик и навигацию по веб-сайту, наблюдать за системой, а также улучшать текущие операции, например, сохранять Ваши предпочтения для оптимизации Ваших последующих посещений веб-сайта. Они не удаляются автоматически при закрытии браузера, а сохраняются на Вашем компьютере на определенный срок (например, до конца следующего года), или же до тех пор, пока Вы не удалите их. Для получения более подробной информации по настройке и удалению файлов cookies, перейдите к разделу &quot;Управление файлами Cookies&quot;, приведенному ниже.&lt;/p&gt;&lt;p&gt;&lt;b&gt;\r\nПрофильные файлы cookies&lt;/b&gt;&lt;/p&gt;&lt;p&gt;\r\nВеб-сайт Fidelitti.com использует профильные файлы cookies компании Fidelitti и независимых провайдеров услуг для отслеживания Вашей навигации по нашему веб-сайту в целях создания профилей на основе Ваших вкусов, привычек, выбора и т. д.; и, следовательно, позволяет нам отправлять Вам рекламные сообщения, отвечающие Вашим предпочтениям. Обратите внимание, что их отключение или удаление не позволит нам посылать рекламные сообщения, отвечающие Вашим предпочтениям, а также может повлиять на правильное функционирование некоторых услуг и на доступ к некоторым разделам веб-сайта. &lt;/p&gt;', 'Политика cookies', '', ''),
(9, 4, 'Политика cookies', '&lt;ul style=&quot;box-sizing: inherit; list-style-position: outside; list-style-image: initial; margin-right: 0px; margin-bottom: 1rem; margin-left: 8px; padding: 0px; color: rgb(10, 10, 10); font-family: Helvetica; font-size: 16px; letter-spacing: 0.9px;&quot;&gt;&lt;li style=&quot;box-sizing: inherit; margin: 0px; padding: 9px 0px 0px 31px; font-size: inherit; list-style-type: none; background: url(&amp;quot;/catalog/view/theme/fidelitti/images/jobs-icon-list.png&amp;quot;) 14px 17px no-repeat;&quot;&gt;&lt;a href=&quot;http://test.fidelitti.com/cookies&quot; rel=&quot;insert&quot; style=&quot;box-sizing: inherit; outline: none; line-height: inherit; color: rgb(0, 0, 0); cursor: pointer;&quot;&gt;Политика cookies&lt;/a&gt;&lt;/li&gt;&lt;/ul&gt;', 'Политика cookies', '', '');
...
(216, 14, 'newsletter.42', 'footer', 0),
(202, 2, 'cosyone_recently.44', 'content_bottom', 1),
(220, 5, 'cosyone_banner.32', 'column_left', 2),
(219, 5, 'cosyone_category', 'column_left', 1),
(227, 16, 'blog_category', 'content_top', 0),
(237, 3, 'adv_ajaxfilter', 'content_top', 0);
...
(141, 11, 0, 'information/information'),
(86, 7, 0, 'checkout/%'),
(144, 8, 0, 'information/contact'),
(32, 9, 0, 'information/sitemap'),
(34, 4, 0, ''),
(127, 5, 0, 'product/manufacturer/info'),
(52, 12, 0, 'product/compare'),
(143, 13, 0, 'product/search'),
(64, 15, 0, 'blog/%'),
(126, 5, 0, 'product/manufacturer'),
(87, 7, 0, 'quickcheckout/%'),
(89, 15, 0, 'module/mega_filter/results'),
(152, 3, 0, 'product/category'),
(136, 16, 0, 'blog/home'),
(139, 17, 0, 'information/informationf'),
(151, 3, 0, 'product/special');
...
(16, 0, 'INV-2013-00', 0, 'fidelitti', 'http://new.fidelitti.loc/', 0, 1, 'ereye', 'tertret', 'dsg@gdfgf.hfgh', '3453454', '', '[]', 'ereye', 'tertret', '', 'fdgdfgdf', '', 'dfgdfg', '', 'Norway', 160, 'Oslo', 2440, '', '[]', 'Оплата при доставке', 'cod', 'ereye', 'tertret', '', 'fdgdfgdf', '', 'dfgdfg', '', 'Norway', 160, 'Oslo', 2440, '', '[]', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', '', '2227.0000', 1, 0, '0.0000', 0, '', 2, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-08-09 18:37:11', '2017-08-09 18:37:18', 0),
(17, 0, 'INV-2013-00', 0, 'fidelitti', 'http://new.fidelitti.loc/', 1, 1, 'test', '', 'test@test.ua', '000', '', '', 'test', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Оплата при доставке', 'cod', 'test', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', '', '3333.0000', 1, 0, '0.0000', 0, '', 3, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-08-10 18:08:06', '2017-08-10 18:08:07', 0),
(18, 0, 'INV-2013-00', 0, 'fidelitti', 'http://new.fidelitti.loc/', 1, 1, 'test', '', 'test@test.ua', '000', '', '', 'test', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Оплата при доставке', 'cod', 'test', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', '', '3190.0000', 1, 0, '0.0000', 0, '', 2, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-08-10 18:08:42', '2017-08-10 18:08:42', 0),
(19, 0, 'INV-2013-00', 0, 'fidelitti', 'http://new.fidelitti.loc/', 0, 1, 'asdasd', 'sedfdf', 'wqeqwew@sfds.gf', '2343423', '', '[]', 'asdasd', 'sedfdf', '', 'fdgdfgdf', '', 'dfgdfg', '', 'Spain', 195, '', 0, '', '[]', 'Оплата при доставке', 'cod', 'asdasd', 'sedfdf', '', 'fdgdfgdf', '', 'dfgdfg', '', 'Spain', 195, '', 0, '', '[]', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', '', '3338.0000', 1, 0, '0.0000', 0, '', 2, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-08-11 16:14:48', '2017-08-11 16:14:57', 0),
(20, 0, 'INV-2013-00', 0, 'fidelitti', 'http://new.fidelitti.loc/', 0, 1, 'fghfghfg', 'fghfgh', 'fghfg@dfg.hfgh', '546456', '', '[]', 'fghfghfg', 'fghfgh', '', 'fdgdfgdf', '', 'dfgdfg', '', 'Croatia', 53, 'Istarska', 850, '', '[]', 'Оплата при доставке', 'cod', 'fghfghfg', 'fghfgh', '', 'fdgdfgdf', '', 'dfgdfg', '', 'Croatia', 53, 'Istarska', 850, '', '[]', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', '', '3338.0000', 0, 0, '0.0000', 0, '', 2, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-08-14 12:05:42', '2017-08-14 12:05:42', 0),
(21, 0, 'INV-2013-00', 0, 'fidelitti', 'http://fidelitti.loc/', 1, 1, 'test', '', 'test@test.ua', '000', '', '', 'test', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Оплата при доставке', 'cod', 'test', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', '', '2940.0000', 1, 0, '0.0000', 0, '', 3, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-08-16 02:53:16', '2017-08-16 02:53:16', 0),
(22, 0, 'INV-2013-00', 0, 'Fidelitti', 'http://new.fidelitti.loc/', 0, 1, 'asasd', 'asdasdas', 'asdasd@dfdsf.df', '23423423', '', '[]', 'asasd', 'asdasdas', '', 'ssdfsdf', '', 'dsfsdfsd', '', 'Hong Kong', 96, 'Tsuen Wan New Territories', 1425, '', '[]', 'Оплата при доставке', 'cod', 'asasd', 'asdasdas', '', 'ssdfsdf', '', 'dsfsdfsd', '', 'Hong Kong', 96, 'Tsuen Wan New Territories', 1425, '', '[]', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', '', '3338.0000', 1, 0, '0.0000', 0, '', 3, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-08-16 15:35:50', '2017-08-17 13:10:12', 3),
(23, 0, 'INV-2013-00', 0, 'Fidelitti', 'http://new.fidelitti.loc/', 1, 1, 'test', '', 'test@test.ua', '000', '', '', 'test', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Оплата при доставке', 'cod', 'test', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', '', '3333.0000', 1, 0, '0.0000', 0, '', 2, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-08-18 11:56:29', '2017-08-18 11:56:29', 2),
(24, 0, 'INV-2013-00', 0, 'Fidelitti', 'http://new.fidelitti.loc/', 1, 1, 'test', '', 'test@test.ua', '000', '', '', 'test', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Оплата при доставке', 'cod', 'test', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', '', '3190.0000', 1, 0, '0.0000', 0, '', 2, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-08-18 15:20:21', '2017-08-18 15:20:21', 2),
(25, 0, 'INV-2013-00', 0, 'Fidelitti', 'http://new.fidelitti.loc/', 0, 1, 'dfbgdfgvd', 'dfbdfbfd', 'fba@dfgdf.dfg', '32423423', '', '[]', 'dfbgdfgvd', 'dfbdfbfd', '', 'dfsdfsdf', '', 'sdfsdfsdfsdf', '', 'United States', 223, 'Armed Forces Pacific', 3623, '{firstname} {lastname}\r\n{company}\r\n{address_1}\r\n{address_2}\r\n{city}, {zone} {postcode}\r\n{country}', '[]', 'Cash On Delivery', 'cod', 'dfbgdfgvd', 'dfbdfbfd', '', 'dfsdfsdf', '', 'sdfsdfsdfsdf', '', 'United States', 223, 'Armed Forces Pacific', 3623, '{firstname} {lastname}\r\n{company}\r\n{address_1}\r\n{address_2}\r\n{city}, {zone} {postcode}\r\n{country}', '[]', 'Flat Shipping Rate', 'flat.flat', '', '6794.0000', 1, 0, '0.0000', 0, '', 3, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-08-18 16:49:23', '2017-08-18 16:49:25', 3),
(26, 0, 'INV-2013-00', 0, 'Fidelitti', 'http://new.fidelitti.loc/', 0, 1, 'nnvbnvb', 'vbnvbnvb', 'fgdfgf@fdhfg.hg', '45454', '', '[]', 'nnvbnvb', 'vbnvbnvb', '', 'fghdfhfgh', '', 'fghfghfghgf', '', 'Japan', 107, 'Fukushima', 1664, '', '[]', 'Cash On Delivery', 'cod', 'nnvbnvb', 'vbnvbnvb', '', 'fghdfhfgh', '', 'fghfghfghgf', '', 'Japan', 107, 'Fukushima', 1664, '', '[]', 'Flat Shipping Rate', 'flat.flat', '', '3338.0000', 1, 0, '0.0000', 0, '', 3, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-08-21 17:10:07', '2017-08-21 17:10:18', 0),
(27, 0, 'INV-2013-00', 0, 'Fidelitti', 'http://new.fidelitti.loc/', 1, 1, 'test', '', 'test@test.ua', '000', '', '', 'test', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Оплата при доставке', 'cod', 'test', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', '', '2222.0000', 1, 0, '0.0000', 0, '', 2, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-08-21 18:54:40', '2017-08-21 18:54:40', 0),
(28, 0, 'INV-2013-00', 0, 'Fidelitti', 'http://new.fidelitti.loc/', 1, 1, 'test', '', 'test@test.ua', '000', '', '', 'test', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Оплата при доставке', 'cod', 'test', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', '', '3190.0000', 1, 0, '0.0000', 0, '', 2, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-08-22 14:11:24', '2017-08-22 14:11:24', 0),
(29, 0, 'INV-2013-00', 0, 'Fidelitti', 'http://new.fidelitti.loc/', 1, 1, 'test', '', 'test@test.ua', '000', '', '', 'test', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Оплата при доставке', 'cod', 'test', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', '', '3190.0000', 1, 0, '0.0000', 0, '', 2, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-08-22 17:33:50', '2017-08-22 17:33:50', 0),
(30, 0, 'INV-2013-00', 0, 'Fidelitti', 'http://new.fidelitti.loc/', 1, 1, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Оплата при доставке', 'cod', '', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', '', '3190.0000', 1, 0, '0.0000', 0, '', 2, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-08-22 18:28:09', '2017-08-22 18:28:09', 0),
(31, 0, 'INV-2013-00', 0, 'Fidelitti', 'http://new.fidelitti.loc/', 1, 1, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Оплата при доставке', 'cod', '', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', '', '3190.0000', 1, 0, '0.0000', 0, '', 2, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-08-22 18:28:10', '2017-08-22 18:28:10', 0),
(32, 0, 'INV-2013-00', 0, 'Fidelitti', 'http://new.fidelitti.loc/', 1, 1, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Оплата при доставке', 'cod', '', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', '', '3190.0000', 1, 0, '0.0000', 0, '', 2, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-08-22 18:28:10', '2017-08-22 18:28:10', 0),
(33, 0, 'INV-2013-00', 0, 'Fidelitti', 'http://new.fidelitti.loc/', 1, 1, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Оплата при доставке', 'cod', '', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', '', '3190.0000', 1, 0, '0.0000', 0, '', 2, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-08-22 18:28:11', '2017-08-22 18:28:11', 0),
(34, 0, 'INV-2013-00', 0, 'Fidelitti', 'http://new.fidelitti.loc/', 1, 1, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Оплата при доставке', 'cod', '', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', '', '3190.0000', 1, 0, '0.0000', 0, '', 2, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-08-22 18:28:11', '2017-08-22 18:28:11', 0),
(35, 0, 'INV-2013-00', 0, 'Fidelitti', 'http://new.fidelitti.loc/', 1, 1, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Оплата при доставке', 'cod', '', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', '', '3190.0000', 1, 0, '0.0000', 0, '', 2, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-08-22 18:28:11', '2017-08-22 18:28:11', 0),
(36, 0, 'INV-2013-00', 0, 'Fidelitti', 'http://new.fidelitti.loc/', 1, 1, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Оплата при доставке', 'cod', '', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', '', '3190.0000', 1, 0, '0.0000', 0, '', 2, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-08-22 18:28:11', '2017-08-22 18:28:11', 0),
(37, 0, 'INV-2013-00', 0, 'Fidelitti', 'http://new.fidelitti.loc/', 1, 1, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Оплата при доставке', 'cod', '', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', '', '3190.0000', 1, 0, '0.0000', 0, '', 2, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-08-22 18:28:12', '2017-08-22 18:28:12', 0),
(38, 0, 'INV-2013-00', 0, 'Fidelitti', 'http://new.fidelitti.loc/', 1, 1, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Оплата при доставке', 'cod', '', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', '', '3190.0000', 1, 0, '0.0000', 0, '', 2, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-08-22 18:28:12', '2017-08-22 18:28:12', 0),
(39, 0, 'INV-2013-00', 0, 'Fidelitti', 'http://new.fidelitti.loc/', 1, 1, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Оплата при доставке', 'cod', '', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', '', '3190.0000', 1, 0, '0.0000', 0, '', 2, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-08-22 18:28:51', '2017-08-22 18:28:51', 0),
(40, 0, 'INV-2013-00', 0, 'Fidelitti', 'http://new.fidelitti.loc/', 1, 1, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Оплата при доставке', 'cod', '', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', '', '3190.0000', 1, 0, '0.0000', 0, '', 2, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-08-22 18:29:05', '2017-08-22 18:29:05', 0),
(41, 0, 'INV-2013-00', 0, 'Fidelitti', 'http://new.fidelitti.loc/', 1, 1, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Оплата при доставке', 'cod', '', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', '', '3190.0000', 1, 0, '0.0000', 0, '', 2, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-08-22 18:29:14', '2017-08-22 18:29:14', 0),
(42, 0, 'INV-2013-00', 0, 'Fidelitti', 'http://new.fidelitti.loc/', 1, 1, 'asdasd', '', 'asdas@fsdf.grfgf', 'asdasd', '', '', 'asdasd', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Оплата при доставке', 'cod', 'asdasd', '', '', '', '', '', '', '', 0, '', 0, '', '', 'Доставка с фиксированной стоимостью доставки', 'flat.flat', '', '3190.0000', 1, 0, '0.0000', 0, '', 2, 4, 'UAH', '1.00000000', '127.0.0.1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36', 'ru-RU,ru;q=0.8,en-US;q=0.6,en;q=0.4', '2017-08-22 18:29:32', '2017-08-22 18:29:32', 0);
...
(34, 16, 1, 0, '', '2017-08-09 18:37:18'),
(35, 17, 1, 0, '', '2017-08-10 18:08:07'),
(36, 18, 1, 0, '', '2017-08-10 18:08:42'),
(37, 19, 1, 0, '', '2017-08-11 16:14:57'),
(38, 21, 1, 0, '', '2017-08-16 02:53:16'),
(39, 22, 1, 0, '', '2017-08-16 15:35:53'),
(40, 22, 0, 0, '', '2017-08-17 13:09:03'),
(41, 22, 1, 0, '', '2017-08-17 13:09:03'),
(42, 22, 0, 0, '', '2017-08-17 13:09:47'),
(43, 22, 1, 0, '', '2017-08-17 13:09:47'),
(44, 22, 0, 0, '', '2017-08-17 13:10:12'),
(45, 22, 1, 0, '', '2017-08-17 13:10:12'),
(46, 23, 1, 0, '', '2017-08-18 11:56:29'),
(47, 24, 1, 0, '', '2017-08-18 15:20:21'),
(48, 25, 1, 0, '', '2017-08-18 16:49:25'),
(49, 26, 1, 0, '', '2017-08-21 17:10:18'),
(50, 27, 1, 0, '', '2017-08-21 18:54:40'),
(51, 28, 1, 0, '', '2017-08-22 14:11:24'),
(52, 29, 1, 0, '', '2017-08-22 17:33:50'),
(53, 30, 1, 0, '', '2017-08-22 18:28:09'),
(54, 31, 1, 0, '', '2017-08-22 18:28:10'),
(55, 32, 1, 0, '', '2017-08-22 18:28:10'),
(56, 33, 1, 0, '', '2017-08-22 18:28:11'),
(57, 34, 1, 0, '', '2017-08-22 18:28:11'),
(58, 35, 1, 0, '', '2017-08-22 18:28:11'),
(59, 36, 1, 0, '', '2017-08-22 18:28:11'),
(60, 37, 1, 0, '', '2017-08-22 18:28:12'),
(61, 38, 1, 0, '', '2017-08-22 18:28:12'),
(62, 39, 1, 0, '', '2017-08-22 18:28:51'),
(63, 40, 1, 0, '', '2017-08-22 18:29:05'),
(64, 41, 1, 0, '', '2017-08-22 18:29:14'),
(65, 42, 1, 0, '', '2017-08-22 18:29:32');
...
(17, 16, 443, 'Cylindro', '065/6022/F/V2', 1, '2222.0000', '2222.0000', '0.0000', 0),
(18, 17, 443, 'Cylindro', '065/6022/F/V2', 1, '3333.0000', '3333.0000', '0.0000', 0),
(19, 18, 443, 'Cylindro', '065/6022/F/V2', 1, '3190.0000', '3190.0000', '0.0000', 0),
(20, 19, 443, 'Cylindro', '065/6022/F/V2', 1, '3333.0000', '3333.0000', '0.0000', 0),
(21, 20, 443, 'Cylindro', '065/6022/F/V2', 1, '3333.0000', '3333.0000', '0.0000', 0),
(22, 21, 323, 'Tondo mini', '043/white-pink/SF/V2', 1, '2940.0000', '2940.0000', '0.0000', 0),
(26, 22, 443, 'Cylindro', '065/6022/F/V2', 1, '3333.0000', '3333.0000', '0.0000', 0),
(27, 23, 443, 'Cylindro', '065/6022/F/V2', 1, '3333.0000', '3333.0000', '0.0000', 0),
(28, 24, 443, 'Cylindro', '065/6022/F/V2', 1, '3190.0000', '3190.0000', '0.0000', 0),
(29, 25, 443, 'Cylindro', '065/6022/F/V2', 1, '3333.0000', '3333.0000', '0.0000', 0),
(30, 25, 445, 'Cylindro ', '065/6006/F/V2', 1, '3456.0000', '3456.0000', '0.0000', 0),
(31, 26, 443, 'Cylindro', '065/6022/F/V2', 1, '3333.0000', '3333.0000', '0.0000', 0),
(32, 27, 443, 'Cylindro', '065/6022/F/V2', 1, '2222.0000', '2222.0000', '0.0000', 0),
(33, 28, 443, 'Cylindro', '065/6022/F/V2', 1, '3190.0000', '3190.0000', '0.0000', 0),
(34, 29, 443, 'Cylindro', '065/6022/F/V2', 1, '3190.0000', '3190.0000', '0.0000', 0),
(35, 30, 443, 'Cylindro', '065/6022/F/V2', 1, '3190.0000', '3190.0000', '0.0000', 0),
(36, 31, 443, 'Cylindro', '065/6022/F/V2', 1, '3190.0000', '3190.0000', '0.0000', 0),
(37, 32, 443, 'Cylindro', '065/6022/F/V2', 1, '3190.0000', '3190.0000', '0.0000', 0),
(38, 33, 443, 'Cylindro', '065/6022/F/V2', 1, '3190.0000', '3190.0000', '0.0000', 0),
(39, 34, 443, 'Cylindro', '065/6022/F/V2', 1, '3190.0000', '3190.0000', '0.0000', 0),
(40, 35, 443, 'Cylindro', '065/6022/F/V2', 1, '3190.0000', '3190.0000', '0.0000', 0),
(41, 36, 443, 'Cylindro', '065/6022/F/V2', 1, '3190.0000', '3190.0000', '0.0000', 0),
(42, 37, 443, 'Cylindro', '065/6022/F/V2', 1, '3190.0000', '3190.0000', '0.0000', 0),
(43, 38, 443, 'Cylindro', '065/6022/F/V2', 1, '3190.0000', '3190.0000', '0.0000', 0),
(44, 39, 443, 'Cylindro', '065/6022/F/V2', 1, '3190.0000', '3190.0000', '0.0000', 0),
(45, 40, 443, 'Cylindro', '065/6022/F/V2', 1, '3190.0000', '3190.0000', '0.0000', 0),
(46, 41, 443, 'Cylindro', '065/6022/F/V2', 1, '3190.0000', '3190.0000', '0.0000', 0),
(47, 42, 443, 'Cylindro', '065/6022/F/V2', 1, '3190.0000', '3190.0000', '0.0000', 0);
...
(13, 16, 'sub_total', 'Сумма', '2222.0000', 1),
(14, 16, 'shipping', 'Доставка с фиксированной стоимостью доставки', '5.0000', 3),
(15, 16, 'total', 'Итого', '2227.0000', 9),
(16, 19, 'sub_total', 'Сумма', '3333.0000', 1),
(17, 19, 'shipping', 'Доставка с фиксированной стоимостью доставки', '5.0000', 3),
(18, 19, 'total', 'Итого', '3338.0000', 9),
(19, 20, 'sub_total', 'Сумма', '3333.0000', 1),
(20, 20, 'shipping', 'Доставка с фиксированной стоимостью доставки', '5.0000', 3),
(21, 20, 'total', 'Итого', '3338.0000', 9),
(33, 22, 'total', 'Итого', '3338.0000', 9),
(31, 22, 'sub_total', 'Сумма', '3333.0000', 1),
(32, 22, 'shipping', 'Доставка с фиксированной стоимостью доставки', '5.0000', 3),
(34, 25, 'sub_total', 'Sub-Total', '6789.0000', 1),
(35, 25, 'shipping', 'Flat Shipping Rate', '5.0000', 3),
(36, 25, 'total', 'Total', '6794.0000', 9),
(37, 26, 'sub_total', 'Sub-Total', '3333.0000', 1),
(38, 26, 'shipping', 'Flat Shipping Rate', '5.0000', 3),
(39, 26, 'total', 'Total', '3338.0000', 9);
...
(453, '058/green/F/V2', '058/green/F/V2', '', '', '', '', '', '', 10000, 7, 'catalog/bags/salerno_mini/salernominigreensf/salerno_mini_green_sf_v2_ar-01.jpg', 0, 1, '3190.0000', '0.0000', '0.0000', 0, 0, '2017-07-03', '0.00000000', 1, '18.00000000', '10.00000000', '22.00000000', 1, 1, 1, 16, 1, 1, '2017-07-03 11:08:00', '2017-07-27 15:05:57'),
...
(445, '065/6006/F/V2', '065/6006/F/V2', '', '', '', '', '', '', 9999, 7, 'catalog/bags/zaino_mini/cylindro/cylindrolavenderv2/cylindro_lavender_v2_ar-01.jpg', 0, 1, '3190.0000', '1234.0000', '3456.0000', 0, 0, '2017-06-23', '0.00000000', 1, '16.00000000', '16.00000000', '19.00000000', 1, 1, 1, 16, 1, 1, '2017-06-23 09:50:45', '2017-08-07 15:36:47'),
(444, '065/powder/F/V2', '065/powder/F/V2', '', '', '', '', '', '', 10000, 7, 'catalog/bags/zaino_mini/cylindro/cylindropowder/cylindro_powder_v2_ar-01.jpg', 0, 1, '3190.0000', '0.0000', '0.0000', 0, 0, '2017-06-22', '0.00000000', 1, '16.00000000', '16.00000000', '19.00000000', 1, 1, 1, 12, 1, 2, '2017-06-22 18:22:16', '2017-07-24 12:43:10'),
(443, '065/6022/F/V2', '065/6022/F/V2', '', '', '', '', '', '', 9973, 7, 'catalog/bags/cylindro/cylindrowhite/cylindro_white_v2_ar-01.jpg', 0, 1, '3190.0000', '2222.0000', '3333.0000', 0, 0, '2017-06-22', '0.00000000', 1, '16.00000000', '16.00000000', '19.00000000', 1, 1, 1, 1, 1, 88, '2017-06-22 10:36:33', '2017-08-14 15:29:15'),
(436, '019/640/F/V2', '019/640/F/V2', '', '', '', '', '', '', 10000, 7, 'catalog/bags/tondo/tondo_blue_sky/tondo_skyblue_v2_ar-01.jpg', 0, 1, '3490.0000', '0.0000', '0.0000', 0, 0, '2017-06-03', '0.00000000', 1, '28.00000000', '9.00000000', '30.00000000', 1, 1, 1, 1, 1, 2, '2017-06-03 13:14:08', '2017-07-27 15:12:17'),
(437, '064/6006/F/V2', '064/6006/F/V2', '', '', '', '', '', '', 10000, 7, 'catalog/bags/salerno/marbella_lavender_v2_ar-01.jpg', 0, 1, '2940.0000', '0.0000', '0.0000', 0, 0, '2017-06-03', '0.00000000', 1, '18.00000000', '23.00000000', '12.00000000', 1, 1, 1, 1, 1, 4, '2017-06-03 13:52:23', '2017-07-27 14:59:21'),
(438, '064/6003/F/V2', '064/6003/F/V2', '', '', '', '', '', '', 10000, 7, 'catalog/bags/marbella/marbella_powder/marbella_powder_v2_ar-01.jpg', 0, 1, '2940.0000', '0.0000', '0.0000', 0, 0, '2017-06-03', '0.00000000', 1, '18.00000000', '23.00000000', '12.00000000', 1, 1, 1, 1, 1, 4, '2017-06-03 13:59:27', '2017-07-27 14:59:47'),
...
(424, '027/white-pink/SF/V2', '027/white-pink/SF/V2', '', '', '', '', '', '', 10000, 7, 'catalog/bags/zaino/zaino_white_pink/zaino_white_pink_t_v2_br-01.jpg', 0, 1, '3490.0000', '0.0000', '0.0000', 0, 0, '2017-05-27', '0.00000000', 1, '25.00000000', '26.00000000', '11.00000000', 1, 1, 1, 1, 1, 1, '2017-05-27 13:04:27', '2017-08-03 14:21:43'),
...
(303, '019/6053/F', '019/6053/F', '', '', '', '', '', '', 10000, 7, 'catalog/bags/tondo/tondo_amaranto/tondo_amaranto_ar-01.jpg', 0, 1, '3490.0000', '0.0000', '0.0000', 0, 0, '2017-05-12', '0.00000000', 1, '28.00000000', '9.00000000', '30.00000000', 1, 1, 1, 4, 1, 2, '2017-05-12 22:35:12', '2017-07-08 13:30:38'),
...
(310, '043/6073/F', '043/6073/F', '', '', '', '', '', '', 10000, 7, 'catalog/bags/tondo_mini/tondo_mini_grey/tondo_mini_shark_ar-01.jpg', 0, 1, '2940.0000', '0.0000', '0.0000', 0, 0, '2017-05-12', '0.00000000', 1, '20.00000000', '7.00000000', '21.00000000', 1, 1, 1, 21, 1, 3, '2017-05-12 23:40:18', '2017-07-20 16:41:23'),
...
(323, '043/white-pink/SF/V2', '043/white-pink/SF/V2', '', '', '', '', '', '', 9999, 7, 'catalog/bags/tondo_mini/tondo_mini_white_pink_v2/tondo_mini_white_pink_v2_ar-01.jpg', 0, 1, '2940.0000', '0.0000', '0.0000', 0, 0, '2017-05-12', '0.00000000', 1, '20.00000000', '7.00000000', '21.00000000', 1, 1, 1, 34, 1, 2, '2017-05-13 01:08:54', '2017-07-08 13:43:03'),
...
(337, '043/0/T', '043/0/T', '', '', '', '', '', '', 10000, 7, 'catalog/bags/tondo_mini/tondo_mini_black_ante/tondo_mini_black_ar-01.jpg', 0, 1, '2940.0000', '0.0000', '0.0000', 0, 0, '2017-05-13', '0.00000000', 1, '20.00000000', '7.00000000', '21.00000000', 1, 1, 1, 48, 1, 1, '2017-05-13 22:09:50', '2017-07-08 14:01:29'),
...
(361, '027/6057/F/V2', '027/6057/F/V2', '', '', '', '', '', '', 10000, 7, 'catalog/bags/zaino/zaino_lilac/zaino_blackberry_v2_ar-01.jpg', 0, 1, '3490.0000', '0.0000', '0.0000', 0, 0, '2017-05-13', '0.00000000', 1, '25.00000000', '11.00000000', '26.00000000', 1, 1, 1, 80, 1, 1, '2017-05-14 17:43:48', '2017-07-22 13:27:08'),
...
(442, '065/6032/F/V2', '065/6032/F/V2', '', '', '', '', '', '', 9998, 7, 'catalog/bags/cylindro/cylindromint/cylindro_mint_v2_ar-01.jpg', 0, 1, '3190.0000', '0.0000', '0.0000', 0, 0, '2017-06-22', '0.00000000', 1, '16.00000000', '16.00000000', '19.00000000', 1, 1, 1, 1, 1, 14, '2017-06-22 10:18:38', '2017-08-07 16:29:34'),
...
(374, '061/6070/F', '061/6070/F', '', '', '', '', '', '', 10000, 7, 'catalog/bags/zaino_mini/zaino_mini_marine/zaino_mini_marine_v2_ar-01.jpg', 0, 1, '3190.0000', '0.0000', '0.0000', 0, 0, '2017-05-13', '0.00000000', 1, '21.00000000', '9.00000000', '22.00000000', 1, 1, 1, 99, 1, 1, '2017-05-14 18:18:02', '2017-07-28 17:09:11'),
...
(378, '057/6030/F', '057/6030/F', '', '', '', '', '', '', 10000, 7, 'catalog/bags/salerno/salerno_denim/salerno_denim_ar-01.jpg', 0, 1, '3490.0000', '0.0000', '0.0000', 0, 0, '2017-05-13', '0.00000000', 1, '21.00000000', '11.00000000', '26.00000000', 1, 1, 1, 113, 1, 1, '2017-05-14 18:27:59', '2017-07-08 12:24:43'),
...
(433, '043/6019/F/V2', '043/6019/F/V2', '', '', '', '', '', '', 10000, 7, 'catalog/bags/tondo_mini/tondo_mini_violet_v2/tondo_mini_fuchsia_v2_ar-01-1.jpg', 0, 1, '2940.0000', '0.0000', '0.0000', 0, 0, '2017-05-29', '0.00000000', 1, '20.00000000', '7.00000000', '21.00000000', 1, 1, 1, 1, 1, 1, '2017-05-29 14:52:21', '2017-07-08 14:05:00'),
...
(429, '027/6007/F/V2', '027/6007/F/V2', '', '', '', '', '', '', 10000, 7, 'catalog/bags/zaino/zaino_raspberry_v2/zaino_raspberry_v2_ar-01-1.jpg', 0, 1, '3490.0000', '0.0000', '0.0000', 0, 0, '2017-05-29', '0.00000000', 1, '25.00000000', '11.00000000', '26.00000000', 1, 1, 1, 1, 1, 1, '2017-05-29 14:01:58', '2017-07-22 13:48:00'),
...
(428, '025/0/Т/B', '025/0/Т/B', '', '', '', '', '', '', 10000, 7, 'catalog/bags/modena/modena_black_blue/black-modena11.jpg', 0, 1, '3390.0000', '0.0000', '0.0000', 0, 0, '2017-05-27', '0.00000000', 1, '39.00000000', '33.00000000', '9.00000000', 1, 1, 1, 1, 1, 1, '2017-05-27 15:24:29', '2017-07-08 15:38:14'),
...
(407, '051/6023/F/Blue', '051/6023/F/Blue', '', '', '', '', '', '', 10000, 7, 'catalog/bags/bordo/bordo_black_blue/bordo_black_blue_ar-01.jpg', 0, 1, '3190.0000', '0.0000', '0.0000', 0, 0, '2017-05-14', '0.00000000', 1, '34.00000000', '14.00000000', '20.00000000', 1, 1, 1, 153, 1, 2, '2017-05-14 23:01:49', '2017-07-07 13:20:49'),
...
(412, '013/0-640/Lu', '013/0-640/Lu', '', '', '', '', '', '', 10000, 7, 'catalog/bags/terno/terno-black-lightblue/terno_black_lightblue_ar-01.jpg', 0, 1, '1599.0000', '0.0000', '0.0000', 0, 0, '2017-05-14', '0.00000000', 1, '25.00000000', '3.00000000', '13.00000000', 1, 1, 1, 162, 1, 1, '2017-05-14 23:26:52', '2017-07-27 15:10:31'),
...
(419, '042/0/Lu/Red', '042/0/Lu/Red', '', '', '', '', '', '', 9999, 7, 'catalog/bags/adelle/adelle_black_red_ar-01.jpg', 0, 1, '1490.0000', '1111.0000', '2222.0000', 0, 0, '2017-05-14', '0.00000000', 1, '19.00000000', '11.00000000', '20.00000000', 1, 1, 1, 171, 1, 21, '2017-05-14 23:47:05', '2017-08-14 15:28:58'),
...
(17414, 419, 'catalog/bags/adelle/adelle_black_red_ar-06.jpg', 5),
(17413, 419, 'catalog/bags/adelle/adelle_black_red_ar-05.jpg', 4),
(17412, 419, 'catalog/bags/adelle/adelle_black_red_ar-04.jpg', 3),
(17411, 419, 'catalog/bags/adelle/adelle_black_red_ar-03.jpg', 2),
(17410, 419, 'catalog/bags/adelle/adelle_black_red_ar-02.jpg', 1),
...
(17420, 443, 'catalog/bags/cylindro/cylindrowhite/cylindro_white_v2_ar-02.jpg', 6),
(17419, 443, 'catalog/bags/cylindro/cylindrowhite/cylindro_white_v2_ar-06.jpg', 5),
(17418, 443, 'catalog/bags/cylindro/cylindrowhite/cylindro_white_v2_ar-05.jpg', 4),
(17417, 443, 'catalog/bags/cylindro/cylindrowhite/cylindro_white_v2_ar-04.jpg', 3),
...
(17416, 443, 'catalog/bags/cylindro/cylindrowhite/cylindro_white_v2_ar-03.jpg', 2),
(17415, 443, 'catalog/bags/cylindro/cylindrowhite/cylindro_white_v2_ar-02.jpg', 1),
...
(3799, 419, 1, 0, '500.0000', '0000-00-00', '0000-00-00', 'en'),
...
(113957, 0, 'config', 'config_compression', '0', 0),
(113958, 0, 'config', 'config_secure', '0', 0),
(113959, 0, 'config', 'config_password', '1', 0),
(113960, 0, 'config', 'config_shared', '0', 0),
...
(113928, 0, 'config', 'config_stock_checkout', '1', 0),
(113929, 0, 'config', 'config_affiliate_approval', '0', 0),
(113930, 0, 'config', 'config_affiliate_auto', '1', 0),
(113931, 0, 'config', 'config_affiliate_commission', '', 0),
(113932, 0, 'config', 'config_affiliate_id', '4', 0),
(113933, 0, 'config', 'config_affiliate_mail', '0', 0),
(113934, 0, 'config', 'config_return_id', '0', 0),
(113935, 0, 'config', 'config_return_status_id', '2', 0),
(113936, 0, 'config', 'config_captcha', '', 0),
(113937, 0, 'config', 'config_captcha_page', '[\"review\",\"return\",\"contact\"]', 1),
(113938, 0, 'config', 'config_logo', 'catalog/logo.png', 0),
(113939, 0, 'config', 'config_icon', 'catalog/favicon.png', 0),
(113940, 0, 'config', 'config_ftp_hostname', 'testtheme.net', 0),
(113941, 0, 'config', 'config_ftp_port', '21', 0),
(113942, 0, 'config', 'config_ftp_username', '', 0),
(113943, 0, 'config', 'config_ftp_password', '', 0),
(113944, 0, 'config', 'config_ftp_root', '', 0),
(113945, 0, 'config', 'config_ftp_status', '0', 0),
(113946, 0, 'config', 'config_mail_protocol', 'mail', 0),
(113947, 0, 'config', 'config_mail_parameter', '', 0),
(113948, 0, 'config', 'config_mail_smtp_hostname', '', 0),
(113949, 0, 'config', 'config_mail_smtp_username', '', 0),
(113950, 0, 'config', 'config_mail_smtp_password', '', 0),
(113951, 0, 'config', 'config_mail_smtp_port', '25', 0),
(113952, 0, 'config', 'config_mail_smtp_timeout', '5', 0),
(113953, 0, 'config', 'config_mail_alert', '', 0),
(113954, 0, 'config', 'config_maintenance', '0', 0),
(113955, 0, 'config', 'config_seo_url', '1', 0),
(113956, 0, 'config', 'config_robots', 'abot\r\ndbot\r\nebot\r\nhbot\r\nkbot\r\nlbot\r\nmbot\r\nnbot\r\nobot\r\npbot\r\nrbot\r\nsbot\r\ntbot\r\nvbot\r\nybot\r\nzbot\r\nbot.\r\nbot/\r\n_bot\r\n.bot\r\n/bot\r\n-bot\r\n:bot\r\n(bot\r\ncrawl\r\nslurp\r\nspider\r\nseek\r\naccoona\r\nacoon\r\nadressendeutschland\r\nah-ha.com\r\nahoy\r\naltavista\r\nananzi\r\nanthill\r\nappie\r\narachnophilia\r\narale\r\naraneo\r\naranha\r\narchitext\r\naretha\r\narks\r\nasterias\r\natlocal\r\natn\r\natomz\r\naugurfind\r\nbackrub\r\nbannana_bot\r\nbaypup\r\nbdfetch\r\nbig brother\r\nbiglotron\r\nbjaaland\r\nblackwidow\r\nblaiz\r\nblog\r\nblo.\r\nbloodhound\r\nboitho\r\nbooch\r\nbradley\r\nbutterfly\r\ncalif\r\ncassandra\r\nccubee\r\ncfetch\r\ncharlotte\r\nchurl\r\ncienciaficcion\r\ncmc\r\ncollective\r\ncomagent\r\ncombine\r\ncomputingsite\r\ncsci\r\ncurl\r\ncusco\r\ndaumoa\r\ndeepindex\r\ndelorie\r\ndepspid\r\ndeweb\r\ndie blinde kuh\r\ndigger\r\nditto\r\ndmoz\r\ndocomo\r\ndownload express\r\ndtaagent\r\ndwcp\r\nebiness\r\nebingbong\r\ne-collector\r\nejupiter\r\nemacs-w3 search engine\r\nesther\r\nevliya celebi\r\nezresult\r\nfalcon\r\nfelix ide\r\nferret\r\nfetchrover\r\nfido\r\nfindlinks\r\nfireball\r\nfish search\r\nfouineur\r\nfunnelweb\r\ngazz\r\ngcreep\r\ngenieknows\r\ngetterroboplus\r\ngeturl\r\nglx\r\ngoforit\r\ngolem\r\ngrabber\r\ngrapnel\r\ngralon\r\ngriffon\r\ngromit\r\ngrub\r\ngulliver\r\nhamahakki\r\nharvest\r\nhavindex\r\nhelix\r\nheritrix\r\nhku www octopus\r\nhomerweb\r\nhtdig\r\nhtml index\r\nhtml_analyzer\r\nhtmlgobble\r\nhubater\r\nhyper-decontextualizer\r\nia_archiver\r\nibm_planetwide\r\nichiro\r\niconsurf\r\niltrovatore\r\nimage.kapsi.net\r\nimagelock\r\nincywincy\r\nindexer\r\ninfobee\r\ninformant\r\ningrid\r\ninktomisearch.com\r\ninspector web\r\nintelliagent\r\ninternet shinchakubin\r\nip3000\r\niron33\r\nisraeli-search\r\nivia\r\njack\r\njakarta\r\njavabee\r\njetbot\r\njumpstation\r\nkatipo\r\nkdd-explorer\r\nkilroy\r\nknowledge\r\nkototoi\r\nkretrieve\r\nlabelgrabber\r\nlachesis\r\nlarbin\r\nlegs\r\nlibwww\r\nlinkalarm\r\nlink validator\r\nlinkscan\r\nlockon\r\nlwp\r\nlycos\r\nmagpie\r\nmantraagent\r\nmapoftheinternet\r\nmarvin/\r\nmattie\r\nmediafox\r\nmediapartners\r\nmercator\r\nmerzscope\r\nmicrosoft url control\r\nminirank\r\nmiva\r\nmj12\r\nmnogosearch\r\nmoget\r\nmonster\r\nmoose\r\nmotor\r\nmultitext\r\nmuncher\r\nmuscatferret\r\nmwd.search\r\nmyweb\r\nnajdi\r\nnameprotect\r\nnationaldirectory\r\nnazilla\r\nncsa beta\r\nnec-meshexplorer\r\nnederland.zoek\r\nnetcarta webmap engine\r\nnetmechanic\r\nnetresearchserver\r\nnetscoop\r\nnewscan-online\r\nnhse\r\nnokia6682/\r\nnomad\r\nnoyona\r\nnutch\r\nnzexplorer\r\nobjectssearch\r\noccam\r\nomni\r\nopen text\r\nopenfind\r\nopenintelligencedata\r\norb search\r\nosis-project\r\npack rat\r\npageboy\r\npagebull\r\npage_verifier\r\npanscient\r\nparasite\r\npartnersite\r\npatric\r\npear.\r\npegasus\r\nperegrinator\r\npgp key agent\r\nphantom\r\nphpdig\r\npicosearch\r\npiltdownman\r\npimptrain\r\npinpoint\r\npioneer\r\npiranha\r\nplumtreewebaccessor\r\npogodak\r\npoirot\r\npompos\r\npoppelsdorf\r\npoppi\r\npopular iconoclast\r\npsycheclone\r\npublisher\r\npython\r\nrambler\r\nraven search\r\nroach\r\nroad runner\r\nroadhouse\r\nrobbie\r\nrobofox\r\nrobozilla\r\nrules\r\nsalty\r\nsbider\r\nscooter\r\nscoutjet\r\nscrubby\r\nsearch.\r\nsearchprocess\r\nsemanticdiscovery\r\nsenrigan\r\nsg-scout\r\nshai\'hulud\r\nshark\r\nshopwiki\r\nsidewinder\r\nsift\r\nsilk\r\nsimmany\r\nsite searcher\r\nsite valet\r\nsitetech-rover\r\nskymob.com\r\nsleek\r\nsmartwit\r\nsna-\r\nsnappy\r\nsnooper\r\nsohu\r\nspeedfind\r\nsphere\r\nsphider\r\nspinner\r\nspyder\r\nsteeler/\r\nsuke\r\nsuntek\r\nsupersnooper\r\nsurfnomore\r\nsven\r\nsygol\r\nszukacz\r\ntach black widow\r\ntarantula\r\ntempleton\r\n/teoma\r\nt-h-u-n-d-e-r-s-t-o-n-e\r\ntheophrastus\r\ntitan\r\ntitin\r\ntkwww\r\ntoutatis\r\nt-rex\r\ntutorgig\r\ntwiceler\r\ntwisted\r\nucsd\r\nudmsearch\r\nurl check\r\nupdated\r\nvagabondo\r\nvalkyrie\r\nverticrawl\r\nvictoria\r\nvision-search\r\nvolcano\r\nvoyager/\r\nvoyager-hc\r\nw3c_validator\r\nw3m2\r\nw3mir\r\nwalker\r\nwallpaper\r\nwanderer\r\nwauuu\r\nwavefire\r\nweb core\r\nweb hopper\r\nweb wombat\r\nwebbandit\r\nwebcatcher\r\nwebcopy\r\nwebfoot\r\nweblayers\r\nweblinker\r\nweblog monitor\r\nwebmirror\r\nwebmonkey\r\nwebquest\r\nwebreaper\r\nwebsitepulse\r\nwebsnarf\r\nwebstolperer\r\nwebvac\r\nwebwalk\r\nwebwatch\r\nwebwombat\r\nwebzinger\r\nwhizbang\r\nwhowhere\r\nwild ferret\r\nworldlight\r\nwwwc\r\nwwwster\r\nxenu\r\nxget\r\nxift\r\nxirq\r\nyandex\r\nyanga\r\nyeti\r\nyodao\r\nzao\r\nzippp\r\nzyborg', 0),
(113927, 0, 'config', 'config_stock_warning', '0', 0),
(113926, 0, 'config', 'config_stock_display', '0', 0),
(113925, 0, 'config', 'config_api_id', '1', 0),
(113924, 0, 'config', 'config_order_mail', '1', 0),
(113923, 0, 'config', 'config_fraud_status_id', '7', 0),
(113922, 0, 'config', 'config_complete_status', '[\"5\",\"3\"]', 1),
...
(113113, 0, 'blogsetting', 'blogsetting_post_thumbs_h', '471', 0),
(113112, 0, 'blogsetting', 'blogsetting_post_thumbs_w', '848', 0),
(113111, 0, 'blogsetting', 'blogsetting_post_thumb', '1', 0),
(113110, 0, 'blogsetting', 'blogsetting_share', '1', 0),
(113109, 0, 'blogsetting', 'blogsetting_post_author', '1', 0),
(113108, 0, 'blogsetting', 'blogsetting_post_page_view', '1', 0),
(113107, 0, 'blogsetting', 'blogsetting_post_comments_count', '1', 0),
(113106, 0, 'blogsetting', 'blogsetting_post_date_added', '1', 0),
(113105, 0, 'blogsetting', 'blogsetting_author', '1', 0),
(113104, 0, 'blogsetting', 'blogsetting_page_view', '1', 0),
(113103, 0, 'blogsetting', 'blogsetting_comments_count', '1', 0),
(113102, 0, 'blogsetting', 'blogsetting_date_added', '1', 0),
(113101, 0, 'blogsetting', 'blogsetting_thumbs_h', '371', 0),
(113100, 0, 'blogsetting', 'blogsetting_thumbs_w', '500', 0),
(113099, 0, 'blogsetting', 'blogsetting_layout', '1', 0),
(113098, 0, 'blogsetting', 'blogsetting_blogs_per_page', '5', 0),
(109244, 0, 'mega_filter_seo', 'mega_filter_seo', '{\"enabled\":\"0\"}', 1),
(113097, 0, 'blogsetting', 'blogsetting_home_meta_keyword', '{\"3\":\"\",\"2\":\"\",\"4\":\"\"}', 1),
(113096, 0, 'blogsetting', 'blogsetting_home_meta_description', '{\"3\":\"\",\"2\":\"\",\"4\":\"\"}', 1),
(113095, 0, 'blogsetting', 'blogsetting_home_description', '{\"3\":\"\",\"2\":\"\",\"4\":\"\"}', 1),
(113094, 0, 'blogsetting', 'blogsetting_home_page_title', '{\"3\":\"\",\"2\":\"\",\"4\":\"\"}', 1),
(113677, 0, 'cosyone', 'cosyone_salebadge_background', 'b01e3b', 0),
(113676, 0, 'cosyone', 'cosyone_offer_color', 'b01e3b', 0),
(773, 0, 'theme_default', 'theme_default_status', '1', 0),
(772, 0, 'theme_default', 'theme_default_directory', 'cosyone', 0),
(113675, 0, 'cosyone', 'cosyone_secondary_color', '492a2f', 0),
(113674, 0, 'cosyone', 'cosyone_primary_color', 'b01e3b', 0),
(113673, 0, 'cosyone', 'cosyone_link_hover_color', '8c0303', 0),
(113672, 0, 'cosyone', 'cosyone_shortcut_separator', '', 0),
(113671, 0, 'cosyone', 'cosyone_menu_link_background_hover', '8c0303', 0),
(113670, 0, 'cosyone', 'cosyone_menu_link_color_hover', 'ffffff', 0),
(113669, 0, 'cosyone', 'cosyone_menu_link_color', '222226', 0),
(113668, 0, 'cosyone', 'cosyone_menu_background', 'ffffff', 0),
(113667, 0, 'cosyone', 'cosyone_top_border_link_hover', 'ffffff', 0),
(113666, 0, 'cosyone', 'cosyone_top_border_link', 'd7d9d9', 0),
(113665, 0, 'cosyone', 'cosyone_top_border_text', 'bdbfbf', 0),
(113664, 0, 'cosyone', 'cosyone_top_border_border', '2b2b2b', 0),
(113663, 0, 'cosyone', 'cosyone_top_border_background', '2b2b2b', 0),
(113662, 0, 'cosyone', 'cosyone_custom_bg_icon', '', 0),
(113661, 0, 'cosyone', 'cosyone_body_image', 'none.png', 0),
(113660, 0, 'cosyone', 'cosyone_body_background', 'ffffff', 0),
(113659, 0, 'cosyone', 'cosyone_container_layout', '', 0),
(113658, 0, 'cosyone', 'cosyone_use_custom', '1', 0),
(113657, 0, 'cosyone', 'cosyone_ie_update_text', '{\"3\":\"\",\"2\":\"\",\"4\":\"\"}', 1),
(113656, 0, 'cosyone', 'cosyone_ie_url', '', 0),
(113655, 0, 'cosyone', 'cosyone_ie_text', '{\"3\":\"\",\"2\":\"\",\"4\":\"\"}', 1),
(113654, 0, 'cosyone', 'cosyone_use_ie', '0', 0),
(113653, 0, 'cosyone', 'cosyone_cookie_button_accept', '{\"3\":\"\",\"2\":\"Accept\",\"4\":\"\"}', 1),
(113652, 0, 'cosyone', 'cosyone_cookie_button_readmore', '{\"3\":\"\",\"2\":\"\\u041f\\u043e\\u0434\\u0440\\u043e\\u0431\\u043d\\u0435\\u0435\",\"4\":\"\"}', 1),
(113651, 0, 'cosyone', 'cosyone_readmore_url', 'index.php?route=information/information&amp;information_id=3', 0),
(113650, 0, 'cosyone', 'cosyone_cookie_text', '{\"3\":\"\",\"2\":\"This website uses cookies in order to work correctly. No personal data is stored\",\"4\":\"\"}', 1),
(113649, 0, 'cosyone', 'cosyone_use_cookie', '0', 0),
(113648, 0, 'cosyone', 'cosyone_footer_payment_icon', '', 0),
(113647, 0, 'cosyone', 'cosyone_footer_custom_block', '{\"3\":\"\",\"2\":\"&lt;p&gt;&lt;br&gt;&lt;\\/p&gt;\",\"4\":\"\"}', 1),
...
(112776, 0, 'cosyone_twitterfeed', 'cosyone_twitterfeed_status', '1', 0),
(112774, 0, 'cosyone_twitterfeed', 'cosyone_twitterfeed_widget_id', '', 0),
(112775, 0, 'cosyone_twitterfeed', 'cosyone_twitterfeed_limit', '', 0),
(112773, 0, 'cosyone_twitterfeed', 'cosyone_twitterfeed_title', '{\"3\":\"\",\"2\":\"\",\"4\":\"\"}', 1),
...
(113921, 0, 'config', 'config_processing_status', '[\"5\",\"1\",\"2\",\"12\",\"3\"]', 1),
(113920, 0, 'config', 'config_order_status_id', '1', 0),
(113919, 0, 'config', 'config_checkout_id', '0', 0),
(113918, 0, 'config', 'config_checkout_guest', '1', 0),
(113917, 0, 'config', 'config_cart_weight', '0', 0),
(113916, 0, 'config', 'config_invoice_prefix', 'INV-2013-00', 0),
(113093, 0, 'blogsetting', 'blogsetting_home_title', '{\"3\":\"\",\"2\":\"\",\"4\":\"\"}', 1),
(113646, 0, 'cosyone', 'cosyone_footer_custom_block_title', '{\"3\":\"Follow us\",\"2\":\"\\u0421\\u043b\\u0435\\u0434\\u0438\\u0442\\u0435 \\u0437\\u0430 \\u043d\\u0430\\u043c\\u0438\",\"4\":\"\\u0421\\u043b\\u0456\\u0434\\u043a\\u0443\\u0439\\u0442\\u0435 \\u0437\\u0430 \\u043d\\u0430\\u043c\\u0438\"}', 1),
(113644, 0, 'cosyone', 'cosyone_brand', 'enabled', 0),
(113645, 0, 'cosyone', 'cosyone_footer_columns', 'column-1', 0),
(113643, 0, 'cosyone', 'cosyone_percentage_sale_badge', 'enabled', 0),
(113642, 0, 'cosyone', 'cosyone_rollover_effect', 'enabled', 0),
(113641, 0, 'cosyone', 'cosyone_grid_related', 'grid3', 0),
(113640, 0, 'cosyone', 'cosyone_grid_category', 'grid3', 0),
(113639, 0, 'cosyone', 'cosyone_default_view', 'grid', 0),
(113630, 0, 'cosyone', 'cosyone_image_options', 'thumbs', 0),
(113631, 0, 'cosyone', 'cosyone_category_thumb', 'enabled', 0),
(113632, 0, 'cosyone', 'cosyone_category_refine', '', 0),
(113633, 0, 'cosyone', 'cosyone_category_per_row', 'grid4', 0),
(113634, 0, 'cosyone', 'cosyone_refine_image_w', '250', 0),
(113635, 0, 'cosyone', 'cosyone_refine_image_h', '160', 0),
(113636, 0, 'cosyone', 'cosyone_google_map', '', 0),
(113637, 0, 'cosyone', 'cosyone_text_ql', '{\"3\":\"\",\"2\":\"Quicklook\",\"4\":\"\"}', 1),
(113638, 0, 'cosyone', 'cosyone_default_product_style', 'style-2', 0),
(113915, 0, 'config', 'config_account_mail', '0', 0),
(113914, 0, 'config', 'config_account_id', '0', 0),
(113913, 0, 'config', 'config_login_attempts', '5', 0),
(113912, 0, 'config', 'config_customer_price', '0', 0),
(113911, 0, 'config', 'config_customer_group_display', '[\"1\"]', 1),
...
(113092, 0, 'adv_ajaxfilter', 'adv_ajaxfilter_module', '[{\"module_title\":\"\",\"module_color\":\"0088CC\",\"module_border_color\":\"39C6FA\",\"module_hover_color\":\"2896FA\",\"module_text_color\":\"FFFFFF\"}]', 1),
(113090, 0, 'adv_ajaxfilter', 'adv_ajaxfilter_status', '1', 0),
(113874, 0, 'quickcheckout', 'quickcheckout_countdown_time', '', 0),
(113875, 0, 'quickcheckout', 'quickcheckout_countdown_text', '{\"3\":\"\",\"2\":\"\",\"4\":\"\"}', 1),
(113870, 0, 'quickcheckout', 'quickcheckout_countdown', '0', 0),
(113871, 0, 'quickcheckout', 'quickcheckout_countdown_start', '0', 0),
(113872, 0, 'quickcheckout', 'quickcheckout_countdown_date_start', '', 0),
(113873, 0, 'quickcheckout', 'quickcheckout_countdown_date_end', '', 0),
(113869, 0, 'quickcheckout', 'quickcheckout_delivery_days_of_week', '', 0),
(113868, 0, 'quickcheckout', 'quickcheckout_delivery_max', '30', 0),
(113867, 0, 'quickcheckout', 'quickcheckout_delivery_min', '1', 0),
(113865, 0, 'quickcheckout', 'quickcheckout_delivery_required', '0', 0),
(113866, 0, 'quickcheckout', 'quickcheckout_delivery_unavailable', '&quot;31-10-2013&quot;, &quot;08-11-2013&quot;, &quot;25-12-2013&quot;', 0),
(113861, 0, 'quickcheckout', 'quickcheckout_survey_text', '{\"3\":\"\",\"2\":\"\",\"4\":\"\"}', 1),
(113862, 0, 'quickcheckout', 'quickcheckout_survey_type', '0', 0),
(113863, 0, 'quickcheckout', 'quickcheckout_delivery', '0', 0),
(113864, 0, 'quickcheckout', 'quickcheckout_delivery_time', '0', 0),
(113860, 0, 'quickcheckout', 'quickcheckout_survey_required', '0', 0),
(113859, 0, 'quickcheckout', 'quickcheckout_survey', '0', 0),
(113858, 0, 'quickcheckout', 'quickcheckout_html_footer', '{\"3\":\"\",\"2\":\"\",\"4\":\"\"}', 1),
(113856, 0, 'quickcheckout', 'quickcheckout_login_module', '1', 0),
(113857, 0, 'quickcheckout', 'quickcheckout_html_header', '{\"3\":\"\",\"2\":\"\",\"4\":\"\"}', 1),
(113855, 0, 'quickcheckout', 'quickcheckout_payment_module', '1', 0),
(113853, 0, 'quickcheckout', 'quickcheckout_cart', '1', 0),
(113854, 0, 'quickcheckout', 'quickcheckout_shipping_module', '1', 0),
(113851, 0, 'quickcheckout', 'quickcheckout_voucher', '0', 0),
(113852, 0, 'quickcheckout', 'quickcheckout_reward', '1', 0),
(113850, 0, 'quickcheckout', 'quickcheckout_coupon', '1', 0),
(113847, 0, 'quickcheckout', 'quickcheckout_field_zone', '{\"display\":\"on\",\"default\":\"1\",\"sort_order\":\"14\"}', 1),
(113848, 0, 'quickcheckout', 'quickcheckout_field_newsletter', '{\"display\":\"on\",\"default\":\"on\",\"sort_order\":\"\"}', 1),
(113849, 0, 'quickcheckout', 'quickcheckout_field_register', '{\"display\":\"on\",\"sort_order\":\"\"}', 1),
(113846, 0, 'quickcheckout', 'quickcheckout_field_country', '{\"display\":\"on\",\"required\":\"on\",\"default\":\"1\",\"sort_order\":\"13\"}', 1),
(113845, 0, 'quickcheckout', 'quickcheckout_field_postcode', '{\"default\":\"\",\"sort_order\":\"12\"}', 1),
(113844, 0, 'quickcheckout', 'quickcheckout_field_city', '{\"display\":\"on\",\"required\":\"on\",\"default\":\"\",\"sort_order\":\"11\"}', 1),
(113843, 0, 'quickcheckout', 'quickcheckout_field_address_2', '{\"default\":\"\",\"sort_order\":\"10\"}', 1),
(113629, 0, 'cosyone', 'cosyone_product_zoom', 'cloud-zoom-gallery', 0),
(113628, 0, 'cosyone', 'cosyone_product_hurry', 'header_border', 0),
(113627, 0, 'cosyone', 'cosyone_product_countdown', 'header_border', 0),
(113626, 0, 'cosyone', 'cosyone_product_yousave', 'enabled', 0),
(113625, 0, 'cosyone', 'cosyone_product_share', 'content', 0),
(113624, 0, 'cosyone', 'cosyone_menu_custom_block_content', '{\"3\":\"\",\"2\":\"\",\"4\":\"\"}', 1),
(113623, 0, 'cosyone', 'cosyone_custom_menu_block_title', '{\"3\":\"\",\"2\":\"\",\"4\":\"\"}', 1),
(113622, 0, 'cosyone', 'cosyone_menu_block_width', '1140', 0),
(113621, 0, 'cosyone', 'cosyone_custom_menu_block', 'disabled', 0),
(113620, 0, 'cosyone', 'cosyone_custom_menu_url6', '', 0),
(113619, 0, 'cosyone', 'cosyone_custom_menu_title6', '{\"3\":\"\",\"2\":\"\",\"4\":\"\"}', 1),
(113618, 0, 'cosyone', 'cosyone_custom_menu_url5', '', 0),
(113617, 0, 'cosyone', 'cosyone_custom_menu_title5', '{\"3\":\"\",\"2\":\"\",\"4\":\"\"}', 1),
(113616, 0, 'cosyone', 'cosyone_custom_menu_url4', '', 0),
(113615, 0, 'cosyone', 'cosyone_custom_menu_title4', '{\"3\":\"\",\"2\":\"\",\"4\":\"\"}', 1),
(113612, 0, 'cosyone', 'cosyone_custom_menu_url2', '/#', 0),
(113613, 0, 'cosyone', 'cosyone_custom_menu_title3', '{\"3\":\"\",\"2\":\"\",\"4\":\"\"}', 1),
(113614, 0, 'cosyone', 'cosyone_custom_menu_url3', '', 0),
(113910, 0, 'config', 'config_customer_group_id', '1', 0),
(113909, 0, 'config', 'config_customer_online', '0', 0),
(113908, 0, 'config', 'config_tax_customer', 'shipping', 0),
(113907, 0, 'config', 'config_tax_default', 'shipping', 0),
(113906, 0, 'config', 'config_tax', '1', 0),
(113905, 0, 'config', 'config_voucher_max', '1000', 0),
(113904, 0, 'config', 'config_voucher_min', '1', 0),
(113091, 0, 'adv_ajaxfilter', 'adv_ajaxfilter_setting', '{\"price_slider\":\"1\",\"display_manufacturer\":\"none\",\"display_categories\":\"checkbox\",\"display_filters\":\"checkbox\",\"display_attribute_12\":\"none\",\"attr_delimeter\":\":\",\"tax\":\"0\",\"option_mode\":\"or\",\"filter_group_mode\":\"or\",\"attribute_mode\":\"or\",\"attribute_value_mode\":\"or\",\"attr_group\":\"0\",\"adv_ajaxfilter_container\":\"list\"}', 1),
(113114, 0, 'blogsetting', 'blogsetting_rel_blog_per_row', '2', 0),
(113115, 0, 'blogsetting', 'blogsetting_rel_thumb', '1', 0),
(113116, 0, 'blogsetting', 'blogsetting_rel_thumbs_w', '409', 0),
(113117, 0, 'blogsetting', 'blogsetting_rel_thumbs_h', '227', 0),
(113118, 0, 'blogsetting', 'blogsetting_rel_characters', '100', 0),
(113119, 0, 'blogsetting', 'blogsetting_comment_per_page', '0', 0),
(113120, 0, 'blogsetting', 'blogsetting_comment_approve', '0', 0),
(113121, 0, 'blogsetting', 'blogsetting_comment_notification', '0', 0),
(113122, 0, 'blogsetting', 'blogsetting_author_change', '0', 0),
(113123, 0, 'blog_category', 'blog_category_status', '1', 0),
(113842, 0, 'quickcheckout', 'quickcheckout_field_address_1', '{\"display\":\"on\",\"required\":\"on\",\"default\":\"\",\"sort_order\":\"9\"}', 1),
(113841, 0, 'quickcheckout', 'quickcheckout_field_customer_group', '{\"sort_order\":\"7\"}', 1),
(113839, 0, 'quickcheckout', 'quickcheckout_field_fax', '{\"default\":\"\",\"sort_order\":\"5\"}', 1),
(113840, 0, 'quickcheckout', 'quickcheckout_field_company', '{\"default\":\"\",\"sort_order\":\"6\"}', 1),
(113838, 0, 'quickcheckout', 'quickcheckout_field_telephone', '{\"display\":\"on\",\"required\":\"on\",\"default\":\"\",\"sort_order\":\"4\"}', 1),
(113837, 0, 'quickcheckout', 'quickcheckout_field_email', '{\"display\":\"on\",\"required\":\"on\",\"default\":\"\",\"sort_order\":\"3\"}', 1),
(113611, 0, 'cosyone', 'cosyone_custom_menu_title2', '{\"3\":\"About company\",\"2\":\"\\u041e \\u043a\\u043e\\u043c\\u043f\\u0430\\u043d\\u0438\\u0438\",\"4\":\"\\u041f\\u0440\\u043e \\u043a\\u043e\\u043c\\u043f\\u0430\\u043d\\u0456\\u044e\"}', 1),
(113610, 0, 'cosyone', 'cosyone_custom_menu_url1', '/index.php?route=blog/home', 0),
(113609, 0, 'cosyone', 'cosyone_custom_menu_title1', '{\"3\":\"World of Fidelitti\",\"2\":\"\\u041c\\u0438\\u0440 Fidelitti\",\"4\":\"\\u0421\\u0432\\u0456\\u0442 Fidelitti\"}', 1),
(113607, 0, 'cosyone', 'cosyone_menu_mega_second_image_w', '165', 0),
(113608, 0, 'cosyone', 'cosyone_menu_mega_second_image_h', '100', 0),
(113606, 0, 'cosyone', 'cosyone_menu_mega_second_thumb', 'disabled', 0),
(113605, 0, 'cosyone', 'cosyone_menu_border', 'header_border', 0),
(113604, 0, 'cosyone', 'cosyone_show_home_icon', 'disabled', 0),
(113603, 0, 'cosyone', 'cosyone_menu_sticky', 'sticky_menu', 0),
(113602, 0, 'cosyone', 'cosyone_top_promo_message', '{\"3\":\"\",\"2\":\"&lt;b&gt;Free shipping&lt;\\/b&gt; on orders over $100. Need Help? &lt;b&gt;866.526.3979&lt;\\/b&gt;\",\"4\":\"\"}', 1),
(113601, 0, 'cosyone', 'cosyone_header_cart', 'enabled', 0),
(113600, 0, 'cosyone', 'cosyone_header_search', 'enabled', 0),
(113599, 0, 'cosyone', 'cosyone_header_compare', 'disabled', 0),
(113598, 0, 'cosyone', 'cosyone_header_wishlist', 'disabled', 0),
(113597, 0, 'cosyone', 'cosyone_header_login', 'enabled', 0),
(113596, 0, 'cosyone', 'cosyone_header_style', 'header2', 0),
(113595, 0, 'cosyone', 'cosyone_use_retina', '', 0),
(113594, 0, 'cosyone', 'cosyone_use_breadcrumb', '', 0),
(113593, 0, 'cosyone', 'cosyone_use_responsive', 'enabled', 0),
(113592, 0, 'cosyone', 'cosyone_max_width', '1140', 0),
(113903, 0, 'config', 'config_review_mail', '0', 0),
(113902, 0, 'config', 'config_review_guest', '1', 0),
(113901, 0, 'config', 'config_review_status', '1', 0),
(113900, 0, 'config', 'config_limit_admin', '20', 0),
(113899, 0, 'config', 'config_product_count', '0', 0),
(113898, 0, 'config', 'config_weight_class_id', '1', 0),
(113897, 0, 'config', 'config_length_class_id', '1', 0),
(113896, 0, 'config', 'config_currency_auto', '0', 0),
(113895, 0, 'config', 'config_currency', 'UAH', 0),
(113894, 0, 'config', 'config_admin_language', 'ru-ru', 0),
(113893, 0, 'config', 'config_language', 'ru-ru', 0),
(113499, 0, 'information', 'information_status', '1', 0),
(113892, 0, 'config', 'config_zone_id', '3495', 0),
(113888, 0, 'config', 'config_image', '', 0),
(113889, 0, 'config', 'config_open', '', 0),
(113890, 0, 'config', 'config_comment', '', 0),
(113891, 0, 'config', 'config_country_id', '220', 0),
(113878, 0, 'config', 'config_meta_keyword', '', 0),
(113879, 0, 'config', 'config_theme', 'theme_default', 0),
(113880, 0, 'config', 'config_layout_id', '4', 0),
(113881, 0, 'config', 'config_name', 'Fidelitti', 0),
(113882, 0, 'config', 'config_owner', 'Fidelitti', 0),
(113883, 0, 'config', 'config_address', 'Address 1', 0),
(113884, 0, 'config', 'config_geocode', '', 0),
(113885, 0, 'config', 'config_email', 'iragrinchuk@gmail.com', 0),
(113886, 0, 'config', 'config_telephone', '123456789', 0),
(113887, 0, 'config', 'config_fax', '', 0),
(113877, 0, 'config', 'config_meta_description', 'Fidelitti', 0),
(113876, 0, 'config', 'config_meta_title', 'Fidelitti', 0),
(113678, 0, 'cosyone', 'cosyone_price_color', '8c0303', 0),
(113679, 0, 'cosyone', 'cosyone_icons_background_hover', '492a2f', 0),
(113680, 0, 'cosyone', 'cosyone_button_color', '545454', 0),
(113681, 0, 'cosyone', 'cosyone_button_border', '545454', 0),
(113682, 0, 'cosyone', 'cosyone_button_background', 'ffffff', 0),
(113683, 0, 'cosyone', 'cosyone_button_hover_color', 'ffffff', 0),
(113684, 0, 'cosyone', 'cosyone_button_hover_border', '545454', 0),
(113685, 0, 'cosyone', 'cosyone_button_hover_background', '545454', 0),
(113686, 0, 'cosyone', 'cosyone_button2_color', '8c0303', 0),
(113687, 0, 'cosyone', 'cosyone_button2_border', '8c0303', 0),
(113688, 0, 'cosyone', 'cosyone_button2_background', 'ffffff', 0),
(113689, 0, 'cosyone', 'cosyone_button2_hover_color', 'ffffff', 0),
(113690, 0, 'cosyone', 'cosyone_button2_hover_border', '8c0303', 0),
(113691, 0, 'cosyone', 'cosyone_button2_hover_background', '8c0303', 0),
(113692, 0, 'cosyone', 'cosyone_use_custom_font', '1', 0),
(113693, 0, 'cosyone', 'cosyone_font1_import', 'Roboto:400,300,500,700', 0),
(113694, 0, 'cosyone', 'cosyone_font1_name', 'font-family: \'Roboto\', sans-serif;', 0),
(113695, 0, 'cosyone', 'cosyone_font2_import', 'Roboto:400,300,500,700', 0),
(113696, 0, 'cosyone', 'cosyone_font2_name', 'font-family: \'Roboto\', sans-serif;', 0),
(113697, 0, 'cosyone', 'cosyone_use_font_light', '300', 0),
(113698, 0, 'cosyone', 'cosyone_use_font_regular', '400', 0),
(113699, 0, 'cosyone', 'cosyone_use_font_semibold', '500', 0),
(113700, 0, 'cosyone', 'cosyone_use_font_bold', '700', 0),
(113701, 0, 'cosyone', 'cosyone_use_custom_css', '0', 0),
(113702, 0, 'cosyone', 'cosyone_custom_css_content', '', 0),
(113703, 0, 'cosyone', 'cosyone_use_custom_javascript', '0', 0),
(113704, 0, 'cosyone', 'cosyone_custom_javascript_content', '', 0),
(113836, 0, 'quickcheckout', 'quickcheckout_field_lastname', '{\"display\":\"on\",\"required\":\"on\",\"default\":\"\",\"sort_order\":\"2\"}', 1),
(113834, 0, 'quickcheckout', 'quickcheckout_shipping_reload', '0', 0),
(113835, 0, 'quickcheckout', 'quickcheckout_field_firstname', '{\"display\":\"on\",\"required\":\"on\",\"default\":\"\",\"sort_order\":\"1\"}', 1),
(113833, 0, 'quickcheckout', 'quickcheckout_payment_reload', '0', 0),
(113832, 0, 'quickcheckout', 'quickcheckout_country_reload', '1', 0),
(113831, 0, 'quickcheckout', 'quickcheckout_responsive', '0', 0),
(113829, 0, 'quickcheckout', 'quickcheckout_debug', '0', 0),
(113830, 0, 'quickcheckout', 'quickcheckout_auto_submit', '0', 0),
(113828, 0, 'quickcheckout', 'quickcheckout_slide_effect', '0', 0),
(113827, 0, 'quickcheckout', 'quickcheckout_layout', '2', 0),
(113826, 0, 'quickcheckout', 'quickcheckout_text_error', '1', 0),
(113824, 0, 'quickcheckout', 'quickcheckout_edit_cart', '1', 0),
(113825, 0, 'quickcheckout', 'quickcheckout_highlight_error', '1', 0),
(113823, 0, 'quickcheckout', 'quickcheckout_shipping', '1', 0),
(113822, 0, 'quickcheckout', 'quickcheckout_payment', '1', 0),
(113821, 0, 'quickcheckout', 'quickcheckout_payment_logo', '1', 0),
(113820, 0, 'quickcheckout', 'quickcheckout_load_screen', '1', 0),
(113819, 0, 'quickcheckout', 'quickcheckout_status', '1', 0),
(113962, 0, 'config', 'config_file_max_size', '300000', 0),
(113963, 0, 'config', 'config_file_ext_allowed', 'zip\r\ntxt\r\npng\r\njpe\r\njpeg\r\njpg\r\ngif\r\nbmp\r\nico\r\ntiff\r\ntif\r\nsvg\r\nsvgz\r\nzip\r\nrar\r\nmsi\r\ncab\r\nmp3\r\nqt\r\nmov\r\npdf\r\npsd\r\nai\r\neps\r\nps\r\ndoc', 0),
(113964, 0, 'config', 'config_file_mime_allowed', 'text/plain\r\nimage/png\r\nimage/jpeg\r\nimage/gif\r\nimage/bmp\r\nimage/tiff\r\nimage/svg+xml\r\napplication/zip\r\n&quot;application/zip&quot;\r\napplication/x-zip\r\n&quot;application/x-zip&quot;\r\napplication/x-zip-compressed\r\n&quot;application/x-zip-compressed&quot;\r\napplication/rar\r\n&quot;application/rar&quot;\r\napplication/x-rar\r\n&quot;application/x-rar&quot;\r\napplication/x-rar-compressed\r\n&quot;application/x-rar-compressed&quot;\r\napplication/octet-stream\r\n&quot;application/octet-stream&quot;\r\naudio/mpeg\r\nvideo/quicktime\r\napplication/pdf', 0),
(113965, 0, 'config', 'config_error_display', '1', 0),
(113966, 0, 'config', 'config_error_log', '0', 0),
(113967, 0, 'config', 'config_error_filename', 'error.log', 0);
...
(921, 'product_id=56', '-7'),
(922, 'product_id=57', '-8'),
(941, 'information_id=8', 'policy'),
(935, 'information_id=4', 'faq'),
(943, 'informationf_id=8', 'our_production'),
(944, 'informationf_id=7', 'my_company'),
(945, 'information_id=7', 'works');
...
(2, 11, 'Katya', '906f41129cde6131219ea1a5dcaf9e695d140f52', 'lOHtGZ2Ki', 'Катя', 'Катя', '', '', '', '127.0.0.1', 1, '2017-08-16 15:30:56'),
(3, 11, 'Dasha', 'f32db55d4aae1be94fcea761c864dec059252f3b', 'VxCodawDU', 'Даша', 'Даша', '', '', '', '', 1, '2017-08-16 15:31:35');
...
--
-- Индексы таблицы `oc_informationf`
--
ALTER TABLE `oc_informationf`
  ADD PRIMARY KEY (`information_id`);

--
-- Индексы таблицы `oc_informationf_description`
--
ALTER TABLE `oc_informationf_description`
  ADD PRIMARY KEY (`information_id`,`language_id`);

--
-- Индексы таблицы `oc_informationf_to_layout`
--
ALTER TABLE `oc_informationf_to_layout`
  ADD PRIMARY KEY (`information_id`,`store_id`);

--
-- Индексы таблицы `oc_informationf_to_store`
--
ALTER TABLE `oc_informationf_to_store`
  ADD PRIMARY KEY (`information_id`,`store_id`);
...
--
ALTER TABLE `oc_api_session`
  MODIFY `api_session_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=392;
--
...
--
ALTER TABLE `oc_extension`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1466;
--
...
--
-- AUTO_INCREMENT для таблицы `oc_informationf`
--
ALTER TABLE `oc_informationf`
...
--
ALTER TABLE `oc_layout_module`
  MODIFY `layout_module_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=238;
--
-- AUTO_INCREMENT для таблицы `oc_layout_route`
--
ALTER TABLE `oc_layout_route`
  MODIFY `layout_route_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=153;
--
...
--
ALTER TABLE `oc_product_image`
  MODIFY `product_image_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17421;
--
...
--
ALTER TABLE `oc_product_special`
  MODIFY `product_special_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3800;
--
...
--
ALTER TABLE `oc_setting`
  MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113968;
--
