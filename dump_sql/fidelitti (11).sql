...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Авг 16 2017 г., 08:38
...
(443, '065/6022/F/V2', '065/6022/F/V2', '', '', '', '', '', '', 9994, 7, 'catalog/bags/cylindro/cylindrowhite/cylindro_white_v2_ar-01.jpg', 0, 1, '3190.0000', '2222.0000', '3333.0000', 0, 0, '2017-06-22', '0.00000000', 1, '16.00000000', '16.00000000', '19.00000000', 1, 1, 1, 1, 1, 49, '2017-06-22 10:36:33', '2017-08-14 15:29:15'),
...
CREATE TABLE IF NOT EXISTS `oc_product_image` (
  ...
  KEY `product_id` (`product_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=17421 ;
...
CREATE TABLE IF NOT EXISTS `oc_product_special` (
  ...
  KEY `product_id` (`product_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3800 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=113705 ;
