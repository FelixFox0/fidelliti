        ...
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 acount-information-col acount-information-col-edit acount-information-col-edit">          
          <div class="cell-header">            
            <div class="login-form-header">
              <h5 class="login-form-name"><?php echo $text_edit_address; ?></h5>
              <div class="edit-details"><?php echo $adress_discription; ?></div>
              <div class="login-form-req"><?php echo $row_require; ?></div>
            </div>
          </div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
          <div class="form-group required">
            <label class="col-lg-2 col-md-2 col-sm-2 col-xs-3 control-label" for="input-firstname"><?php echo $entry_firstname; ?></label>
          ...
          <div class="form-group required">
            <label class="col-lg-2 col-md-2 col-sm-2 col-xs-3 control-label" for="input-lastname"><?php echo $entry_lastname; ?></label>
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-9 ">
          ...
          <div class="form-group required">
            <label class="col-lg-2 col-md-2 col-sm-2 col-xs-3 control-label" for="input-address-1"><?php echo $entry_address_1; ?></label>
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-9 ">
          ...
          <div class="form-group required">
            <label class="col-lg-2 col-md-2 col-sm-2 col-xs-3 control-label" for="input-city"><?php echo $entry_city; ?></label>
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-9 ">
          ...
          <div class="form-group required">
            <label class="col-lg-2 col-md-2 col-sm-2 col-xs-3 control-label" for="input-country"><?php echo $entry_country; ?></label>
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-9 ">
          ...
          <div class="form-group required">
            <label class="col-lg-2 col-md-2 col-sm-2 col-xs-3 control-label" for="input-zone"><?php echo $entry_zone; ?></label>
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-9 ">
          ...
          <div class="form-group<?php echo ($custom_field['required'] ? ' required' : ''); ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
            <label class="col-lg-2 col-md-2 col-sm-2 col-xs-3 control-label" for="input-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></label>
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-9 ">
          ...
          <div class="form-group<?php echo ($custom_field['required'] ? ' required' : ''); ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
            <label class="col-lg-2 col-md-2 col-sm-2 col-xs-3 control-label"><?php echo $custom_field['name']; ?></label>
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-9 ">
              <div>
                <?php foreach ($custom_field['custom_field_value'] as $custom_field_value) { ?>
                <div class="radio">
          ...
          <?php } ?>
          <div class="form-group">
            <label class="col-lg-2 col-md-2 col-sm-2 col-xs-3 control-label"><?php echo $entry_default; ?></label>
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-9 ">
              <?php if ($default) { ?>
        ...
        <div class="buttons clearfix">
          <div class="pull-left"><input type="submit" value="<?php echo $button_next; ?>" class="btn btn-primary login-form-button" />
          </div>
          <div class="pull-right">
            <input type="submit" value="<?php echo $button_back; ?>" class="btn btn-primary login-form-button" />
          </div>
        </div>
      </form>
