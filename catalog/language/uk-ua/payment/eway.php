...
// Text
$_['text_title']												= 'Оплата кредитною картою (eWAY)';
$_['text_credit_card']											= 'Деталі кредитної карти';
$_['text_testing']												= 'Платіжний шлюз провіряється. Кошти не були зняті.<br />Будь ласка скористайтесь іншим методом оплати.';

$_['text_basket']												= 'Корзина';
$_['text_checkout']												= 'Оплатити';
$_['text_success']												= 'Успішно';
$_['text_shipping']												= 'Доставка';

// Entry
$_['entry_cc_number']											= 'Номер карти';
$_['entry_cc_name']												= 'Власник карти';
$_['entry_cc_expire_date']										= 'Термін дії карти';
$_['entry_cc_cvv2']												= 'Секретний код (CVV2)';
...
$_['text_type_help']											= 'Після натиснення кнопки "Підтвердити замовлення"  Ви будете перенаправлені на ';

$_['text_transaction_failed']									= 'Вибачте, Ваш платіж забраковано.';
