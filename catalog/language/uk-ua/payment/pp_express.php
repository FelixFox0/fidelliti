...
$_['text_trial']			= '%s кожен %s %s із %s платежів тоді';
$_['text_recurring']			= '%s кожен %s %s';
$_['text_recurring_item']		= 'Повторювання елемент';
...
$_['error_too_many_failures']		= 'Ваш платіж не вдалося виконати: занадто багато спроб';