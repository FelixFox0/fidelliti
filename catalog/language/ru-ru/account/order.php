...
$_['text_product_number']   = 'Запрошенный заказ не найден!';
$_['heading_title_chzv']   = 'ЧЗВ';
$_['contact_text']   = 'С помощью загляните в наш раздел Часто задаваемые вопросы или Свяжитесь с нами';
$_['text_product_number']   = 'Количество Ваших заказов сейчас:';
