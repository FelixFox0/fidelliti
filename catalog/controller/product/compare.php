...
class ControllerProductCompare extends Controller {
	public function index() {
		...
		if (isset($this->request->get['remove'])) {
			...
			$this->response->redirect($this->url->link('product/compare', '', false, $this->session->data['country_code'], $this->session->data['language_name']));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('product/compare', '', false, $this->session->data['country_code'], $this->session->data['language_name'])
		);
		...
		foreach ($this->session->data['compare'] as $key => $product_id) {
			...
			if ($product_info) {
				...
				$data['products'][$product_id] = array(
					...
					'href'         => $this->url->link('product/product', 'product_id=' . $product_id, false, $this->session->data['country_code'], $this->session->data['language_name']),
					'remove'       => $this->url->link('product/compare', 'remove=' . $product_id, false, $this->session->data['country_code'], $this->session->data['language_name'])
				);
