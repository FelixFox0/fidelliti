...
class ControllerAccountEdit extends Controller {
	...
	public function index() {
		if (!$this->customer->isLogged()) {
			$this->session->data['redirect'] = $this->url->link('account/edit', '', true, $this->session->data['country_code'], $this->session->data['language_name']);
		...
		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('account/edit', '', true, $this->session->data['country_code'], $this->session->data['language_name'])
		);
		...
		$data['button_change_pass'] = $this->language->get('button_change_pass');
		...
		$data['action'] = $this->url->link('account/edit', '', true, $this->session->data['country_code'], $this->session->data['language_name']);
