...
class ControllerModulePPLogin extends Controller {
	...
	public function index() {
		if (!$this->customer->isLogged()) {
			...
			$data['return_url'] = $this->url->link('module/pp_login/login', '', true, $this->session->data['country_code'], $this->session->data['language_name']);
	...
	public function login() {
		...
		if ($this->customer->isLogged()) {
			echo '<script type="text/javascript">window.opener.location = "' . $this->url->link('account/account', '', true, $this->session->data['country_code'], $this->session->data['language_name']) . '"; window.close();</script>';
		}
		...
		if (!isset($this->request->get['code'])) {
			...
			echo '<script type="text/javascript">window.opener.location = "' . $this->url->link('account/login', '', true, $this->session->data['country_code'], $this->session->data['language_name']) . '"; window.close();</script>';
		} else {
