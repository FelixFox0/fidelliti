...
class ControllerPaymentPPProIframe extends Controller {
	...
	private function constructButtonData($order_info) {
		...
		$s_data['L_BUTTONVAR20'] = 'notify_url=' . $this->url->link('payment/pp_pro_iframe/notify', '', true, $this->session->data['country_code'], $this->session->data['language_name']);
		$s_data['L_BUTTONVAR21'] = 'cancel_return=' . $this->url->link('checkout/checkout', '', true, $this->session->data['country_code'], $this->session->data['language_name']);
		...
		$s_data['L_BUTTONVAR56'] = 'return=' . $this->url->link('checkout/success', '', true, $this->session->data['country_code'], $this->session->data['language_name']);
