...
class ControllerPaymentBluePayRedirect extends Controller {
	...
	public function send() {
		...
		$post_data['APPROVED_URL'] = $this->url->link('payment/bluepay_redirect/callback', '', true, $this->session->data['country_code'], $this->session->data['language_name']);
		$post_data['DECLINED_URL'] = $this->url->link('payment/bluepay_redirect/callback', '', true, $this->session->data['country_code'], $this->session->data['language_name']);
		$post_data['MISSING_URL'] = $this->url->link('payment/bluepay_redirect/callback', '', true, $this->session->data['country_code'], $this->session->data['language_name']);
