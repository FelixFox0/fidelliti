...
class ControllerPaymentLiqPay extends Controller {
	public function index() {
		...
		$xml .= '	<result_url>' . $this->url->link('checkout/success', '', true, $this->session->data['country_code'], $this->session->data['language_name']) . '</result_url>';
		$xml .= '	<server_url>' . $this->url->link('payment/liqpay/callback', '', true, $this->session->data['country_code'], $this->session->data['language_name']) . '</server_url>';
