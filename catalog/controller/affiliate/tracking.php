...
class ControllerAffiliateTracking extends Controller {
	public function index() {
		if (!$this->affiliate->isLogged()) {
			$this->session->data['redirect'] = $this->url->link('affiliate/tracking', '', true, $this->session->data['country_code'], $this->session->data['language_name']);
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('affiliate/tracking', '', true, $this->session->data['country_code'], $this->session->data['language_name'])
		);
		...
		if (isset($this->request->get['filter_name'])) {
			...
			foreach ($results as $result) {
				$json[] = array(
					...
					'link' => str_replace('&amp;', '&', $this->url->link('product/product', 'product_id=' . $result['product_id'] . '&tracking=' . $this->affiliate->getCode(),false, $this->session->data['country_code'], $this->session->data['language_name']))
				);
			}
		}
