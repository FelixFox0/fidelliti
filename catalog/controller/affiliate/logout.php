...
class ControllerAffiliateLogout extends Controller {
	public function index() {
		if ($this->affiliate->isLogged()) {
			...
			$this->response->redirect($this->url->link('affiliate/logout', '', true, $this->session->data['country_code'], $this->session->data['language_name']));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('affiliate/logout', '', true, $this->session->data['country_code'], $this->session->data['language_name'])
		);
