  ...
  <li class=""><a href="<?php echo $home; ?>" class=""><?php echo $text_home; ?></a></li>
    ...
    <?php } ?>
        ...
        <?php } ?>
                ...
                <li><a class="mmobile-lang open-popup" href=".popup-countries"><i class="fa fa-globe" aria-hidden="true"></i></i><?php echo $shippig; ?> <span> <?php echo ' ' . strtoupper($country_s); ?></span></a></li>
