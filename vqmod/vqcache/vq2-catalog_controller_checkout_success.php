...
class ControllerCheckoutSuccess extends Controller {
	public function index() {
		...
		if ($this->customer->isLogged()) {
			...
			$data['text_message'] = sprintf($this->language->get('text_guest'), $this->url->link('information/contact', '', false, $this->session->data['country_code'], $this->session->data['language_name']));
		}
